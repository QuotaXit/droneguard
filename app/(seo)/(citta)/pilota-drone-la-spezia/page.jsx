...
export const metadata = {
  title: "Pilota Drone La Spezia | Trova Piloti Drone a La Spezia | DroneGuard",
  description:
    "Cerchi un pilota drone a La Spezia? Pubblica gratuitamente il tuo lavoro e ricevi candidature da piloti drone per riprese, ispezioni, eventi e servizi professionali."
}

export default function PilotaDroneLaSpeziaPage() {
  return (
    <main className="min-h-screen bg-[#0B0F2A] text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        <h1 className="text-4xl font-bold mb-6">
          Pilota Drone La Spezia
        </h1>

        <p className="text-gray-300 text-lg leading-8 mb-8">
          Cerchi un pilota drone a La Spezia per riprese video, fotografie aeree,
