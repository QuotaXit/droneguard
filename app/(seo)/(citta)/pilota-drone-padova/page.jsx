...
export const metadata = {
  title: "Pilota Drone Padova | Trova Piloti Drone a Padova | DroneGuard",
  description:
    "Cerchi un pilota drone a Padova? Pubblica gratuitamente il tuo lavoro e ricevi candidature da piloti drone per riprese, ispezioni, eventi e servizi professionali."
}

export default function PilotaDronePadovaPage() {
  return (
