...
export const metadata = {
  title: "Pilota Drone Verona | Trova Piloti Drone a Verona | DroneGuard",
  description:
    "Cerchi un pilota drone a Verona? Pubblica gratuitamente il tuo lavoro e ricevi candidature da piloti drone per riprese, ispezioni, eventi e servizi professionali."
}

export default function PilotaDroneVeronaPage() {
  return (
