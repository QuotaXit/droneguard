...
export const metadata = {
  title: "Pilota Drone Matera | Trova Piloti Drone a Matera | DroneGuard",
  description:
    "Cerchi un pilota drone a Matera? Pubblica gratuitamente il tuo lavoro e ricevi candidature da piloti drone per riprese, ispezioni, eventi e servizi professionali."
}

export default function PilotaDroneMateraPage() {
  return (
    <main className="min-h-screen bg-[#0B0F2A] text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        <p className="text-gray-300 text-lg leading-8 mb-8">
          Cerchi un pilota drone a Matera per riprese video, fotografie aeree,
