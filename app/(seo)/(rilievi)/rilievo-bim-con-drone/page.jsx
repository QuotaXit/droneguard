...
export const metadata = {
  title: "Rilievo BIM con drone | DroneGuard",
  description:
    "Rilievo BIM con drone: trova piloti drone per foto, video, ortofoto, modelli 3D, rilievi visivi e documentazione tecnica di terreni, cantieri, aree esterne e strutture complesse."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere rilievo BIM con drone
            </h2>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Nel caso specifico di rilievi per flussi BIM, il drone può essere utilizzato per documentare edifici, cantieri, aree esterne, coperture, facciate e contesti da modellare. Puoi chiedere al pilota foto panoramiche, immagini verticali, video brevi, riprese dei punti critici, ortofoto o materiale predisposto per elaborazioni successive. La scelta dipende dall'obiettivo: vedere lo stato generale, confrontare più fasi, misurare indicativamente superfici, creare una base per un tecnico o preparare una richiesta di preventivo più precisa.
            </p>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="leading-8 text-gray-300">
              Se il servizio riguarda rilievi per flussi BIM, spiega se vuoi soltanto vedere meglio l'area oppure se ti serve materiale tecnico da usare in un progetto. Questa distinzione aiuta il pilota a proporti una consegna realistica, evitando preventivi troppo generici o risultati non adatti.
            </p>
          </div>
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso richiedere rilievo BIM con drone su DroneGuard?
              </h3>
