...
export const metadata = {
  title: "Rilievo pre e post intervento con drone | DroneGuard",
  description:
    "Rilievo pre e post intervento con drone: trova piloti drone per foto, video, ortofoto, modelli 3D, rilievi visivi e documentazione tecnica di terreni, cantieri, aree esterne e strutture complesse."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          ...
          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Rilievo pre e post intervento con drone: trova piloti drone per rilievi, ortofoto e documentazione dall'alto
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Se devi organizzare un rilievo pre e post intervento con drone, DroneGuard ti aiuta a trasformare una necessità tecnica in una richiesta chiara da mostrare a piloti drone disponibili. Puoi pubblicare un annuncio, spiegare cosa deve essere rilevato, indicare il luogo, il tipo di area, il materiale che ti serve e ricevere candidature da operatori interessati. Il drone può essere utile quando bisogna osservare tetti, facciate, cantieri, terreni, aree esterne e opere di manutenzione, perché una vista dall'alto permette di comprendere meglio proporzioni, accessi, pendenze, confini visibili, superfici, ostacoli, zone operative e punti difficili da valutare da terra.
          </p>

          <p className="mt-6 text-lg leading-8 text-gray-300">
            Questa pagina è pensata per clienti, tecnici, imprese, geometri, ingegneri, architetti, aziende, amministratori, proprietari e responsabili di cantiere che cercano un modo semplice per entrare in contatto con piloti drone. Il risultato può essere una raccolta di foto prima e dopo, video, panoramiche e documentazione comparativa, sempre in base alla fattibilità del volo, alle condizioni del luogo, alla sicurezza, alla privacy e alle regole applicabili.
          </p>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Nel caso specifico di rilievi pre e post intervento, il drone può essere utilizzato per documentare tetti, facciate, cantieri, terreni, aree esterne e opere di manutenzione. Puoi chiedere al pilota foto panoramiche, immagini verticali, video brevi, riprese dei punti critici, ortofoto o materiale predisposto per elaborazioni successive. La scelta dipende dall'obiettivo: vedere lo stato generale, confrontare più fasi, misurare indicativamente superfici, creare una base per un tecnico o preparare una richiesta di preventivo più precisa.
            </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per rilievo pre e post intervento con drone
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per rilievo pre e post intervento con drone in provincia. Mi servono immagini dall'alto dell'area, foto panoramiche, eventuali riprese verticali e materiale utile da condividere con il tecnico. Vorrei documentare tetti, facciate, cantieri, terreni, aree esterne e opere di manutenzione. Il materiale servirà per valutare lo stato attuale, preparare un sopralluogo più preciso e capire se richiedere un preventivo o un'elaborazione successiva.”
            </p>
          </div>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="leading-8 text-gray-300">
              Se il servizio riguarda rilievi pre e post intervento, spiega se vuoi soltanto vedere meglio l'area oppure se ti serve materiale tecnico da usare in un progetto. Questa distinzione aiuta il pilota a proporti una consegna realistica, evitando preventivi troppo generici o risultati non adatti.
            </p>
          </div>
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso richiedere rilievo pre e post intervento con drone su DroneGuard?
              </h3>
