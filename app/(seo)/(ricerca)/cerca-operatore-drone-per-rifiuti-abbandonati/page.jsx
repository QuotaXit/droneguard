...
export const metadata = {
  title: "Cerca un operatore drone per rifiuti abbandonati | DroneGuard",
  description: "Cerca un operatore drone per rifiuti abbandonati: pubblica una richiesta su DroneGuard, confronta candidature e scegli piloti drone per foto, video, sopralluoghi e documentazione visiva."
}
    ...
    <main className="min-h-screen bg-[#0B0F2A] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="mb-14 grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="leading-7 text-gray-300">
              Descrivi luogo, obiettivo, urgenza e punti da documentare. Per rifiuti abbandonati puoi indicare in modo chiaro cosa vuoi riprendere e perché ti serve il materiale.
            </p>
          </div>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Perché cercare un pilota drone per rifiuti abbandonati
            </h2>
            <p className="mb-5 leading-8 text-gray-300">Una pagina dedicata a rifiuti abbandonati è utile perché molte persone cercano un servizio preciso e non vogliono perdere tempo con messaggi casuali. Chi ha bisogno di immagini dall alto spesso deve spiegare la situazione a un tecnico, a un amministratore, a un cliente, a un impresa, a una direzione aziendale o a un assicuratore. Per questo la richiesta deve indicare obiettivo, luogo, urgenza, tipo di consegna e punti da riprendere, come cumuli, strade, fossi, aree verdi, accessi, recinzioni e punti critici.</p>
            <p className="mb-5 leading-8 text-gray-300">DroneGuard non è una semplice vetrina statica. La piattaforma aiuta a collegare domanda e offerta: da una parte ci sono comuni, proprietari e associazioni; dall altra ci sono piloti drone che possono valutare il lavoro e candidarsi. Questo rende la ricerca più concreta, perché il cliente non deve solo cercare un numero di telefono, ma può pubblicare un annuncio con informazioni utili e ricevere risposte mirate.</p>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              ...
              <li>✅ punti da riprendere: cumuli, strade, fossi, aree verdi, accessi, recinzioni e punti critici</li>
        ...
        <div className="mb-14">
          ...
          <p className="leading-8 text-gray-300">Per rifiuti abbandonati, un annuncio efficace non deve promettere risultati tecnici che spettano a professionisti abilitati. Il drone può produrre materiale visivo, ma non sostituisce perizie, certificazioni, relazioni strutturali, diagnosi ufficiali o decisioni operative. Proprio per questo è utile descrivere il materiale richiesto come supporto visivo: foto, video, panoramiche, dettagli e documentazione da condividere con chi dovrà poi valutare.</p>
        </div>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="leading-8 text-gray-300">Nel caso di rifiuti abbandonati, il costo finale del servizio non è uguale per tutti. Dipende da distanza, durata, complessità, numero di punti da riprendere, consegna richiesta, urgenza, necessità di montaggio, eventuale ripetizione delle riprese e livello di preparazione. Una richiesta dettagliata permette al pilota di formulare una proposta più corretta e al cliente di confrontare meglio le candidature.</p>
          </div>

          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            <h2 className="mb-4 text-3xl font-bold">Per piloti drone e operatori</h2>
            <p className="mb-5 leading-8 text-gray-300">Per il pilota drone, una pagina come questa è importante perché intercetta clienti con bisogni reali. Chi cerca rifiuti abbandonati non sta leggendo una pagina generica sui droni: sta cercando qualcuno che possa aiutarlo in una situazione concreta. Una candidatura professionale dovrebbe quindi spiegare area di operatività, esperienza simile, disponibilità, limiti del servizio, modalità di consegna e aspetti da verificare prima del volo.</p>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">Che materiale chiedere per rifiuti abbandonati</h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per rifiuti abbandonati. Vorrei foto panoramiche, video breve e immagini dei punti principali: cumuli, strade, fossi, aree verdi, accessi, recinzioni e punti critici. Il materiale servirà per valutare la situazione, confrontarmi con tecnici o collaboratori e capire meglio come organizzare eventuali interventi. Indicherò zona, orari disponibili, referente sul posto e urgenza.”
            </p>
          </div>
          <p className="mt-6 leading-8 text-gray-300">Un annuncio ben scritto dovrebbe contenere luogo o zona, tipo di area, obiettivo, punti da documentare, materiale desiderato, urgenza, disponibilità oraria, eventuale referente e limiti di accesso. Se possibile, conviene aggiungere una descrizione concreta come: vorrei foto panoramiche, dettagli di cumuli, strade, fossi, aree verdi, accessi, recinzioni e punti critici, video breve e consegna ordinata per condividere il materiale con i tecnici.</p>
        </div>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">Nel confronto tra candidature, non guardare solo il prezzo. Valuta chiarezza, esperienza, disponibilità, qualità della comunicazione, esempi di lavori simili, consegna proposta e attenzione alla sicurezza. Per rifiuti abbandonati, un prezzo troppo basso ma senza dettagli può diventare meno utile di una proposta leggermente più alta ma ben spiegata.</p>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              ...
              <li>✅ esperienza in lavori simili a rifiuti abbandonati</li>
        ...
        <div className="mb-14">
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">Posso usare DroneGuard per rifiuti abbandonati?</h3>
              <p className="leading-7 text-gray-300">Sì. Puoi pubblicare una richiesta dedicata a rifiuti abbandonati, indicare luogo, obiettivo e materiale richiesto, poi valutare le candidature dei piloti drone interessati.</p>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="leading-7 text-gray-300">Puoi chiedere foto panoramiche, video, dettagli ravvicinati e documentazione ordinata dei punti più importanti, come cumuli, strade, fossi, aree verdi, accessi, recinzioni e punti critici.</p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">Cerca un operatore drone per rifiuti abbandonati</h2>
          <p className="mb-6 max-w-3xl leading-8 text-gray-700">
            Registrati su DroneGuard, pubblica una richiesta dettagliata e ricevi candidature da piloti interessati. Che tu debba organizzare rifiuti abbandonati, preparare un sopralluogo, documentare una situazione o creare materiale visivo, una richiesta chiara aumenta le possibilità di trovare il professionista giusto.
          </p>
          <Link href="/register">
