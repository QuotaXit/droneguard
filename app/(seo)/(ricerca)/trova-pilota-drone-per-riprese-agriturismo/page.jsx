...
export const metadata = {
  title: "Trova un pilota drone per riprese agriturismo | DroneGuard",
  description: "Trova un pilota drone per riprese agriturismo: pubblica una richiesta su DroneGuard, confronta candidature e scegli piloti drone per foto, video, sopralluoghi e documentazione visiva."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          ...
          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Trova un pilota drone per riprese agriturismo: pubblica la richiesta su DroneGuard
          </h1>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">Trova un pilota drone per riprese agriturismo</h2>
