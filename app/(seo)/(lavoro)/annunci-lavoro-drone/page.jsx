...
export const metadata = {
  title: "Annunci lavoro drone | DroneGuard",
  description:
    "Annunci lavoro drone per clienti e piloti. Su DroneGuard puoi pubblicare richieste o candidarti a lavori con drone per ispezioni, riprese, cantieri, immobili e aziende."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          ...
          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Annunci lavoro drone: pubblica richieste e ricevi candidature
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta clienti che pubblicano lavori e piloti che cercano nuove opportunità a gestire richieste legate a annunci lavoro drone.
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Gli annunci generici spesso non spiegano bene luogo, obiettivo, materiale richiesto e complessità del volo, quindi i piloti faticano a fare una candidatura precisa. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ annunci per ispezioni con drone</li>
              <li>✅ annunci per riprese aeree</li>
              <li>✅ annunci per sopralluoghi tecnici</li>
              <li>✅ annunci per video immobiliari</li>
              <li>✅ annunci per controlli dopo maltempo</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per annunci lavoro drone
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per riprese aeree di un immobile in vendita. Servono foto esterne, breve video panoramico, dettagli del giardino e riprese che mostrino accessi e posizione.”
            </p>
          </div>
