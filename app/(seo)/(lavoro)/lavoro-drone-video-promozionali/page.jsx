...
export const metadata = {
  title: "Lavoro drone video promozionali | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone video promozionali su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per riprese aeree promozionali per aziende, attività turistiche, strutture ricettive, ristoranti, negozi, eventi, cantieri completati e contenuti social indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Video brevi per social e sito web",
  "Riprese di sedi aziendali e attività commerciali",
  "Contenuti per hotel, ristoranti e location",
  "Clip di apertura per presentazioni e campagne",
  "Materiale da integrare con montaggio e voiceover",
...
const approfondimenti = [
  "Un'azienda può voler mostrare la propria sede, una struttura esterna, un evento, una location o un lavoro completato con immagini più dinamiche rispetto alle sole foto da terra.",
  "Il pilota può proporre riprese semplici e ordinate, clip brevi, panoramiche, movimenti fluidi e consegna in formato adatto a chi monterà il video.",
...
const faqs = [
  { q: "DroneGuard può portare lavori per video promozionali?", a: "Sì. Il cliente pubblica la richiesta e i piloti disponibili possono candidarsi spiegando cosa possono riprendere, in che tempi e con quale tipo di consegna." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Video drone per marketing locale
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per video promozionali di aziende e attività
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, aziende, agenzie marketing, attività locali, creator, hotel, ristoranti e professionisti che vogliono immagini più coinvolgenti a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca riprese aeree promozionali per aziende, attività turistiche, strutture ricettive, ristoranti, negozi, eventi, cantieri completati e contenuti social e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per alcune riprese promozionali della nostra attività. Ci servono clip esterne della sede, del parcheggio, dell'ingresso e della zona circostante per un video social.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone video promozionali
          </h2>
