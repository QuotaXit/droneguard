...
export const metadata = {
  title: "Lavori drone fotovoltaico | DroneGuard",
  description:
    "Lavori drone fotovoltaico: cerca piloti per ispezioni visive di pannelli, impianti su tetti, coperture industriali, aziende agricole, capannoni e immobili."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          ...
          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavori drone fotovoltaico: controlli visivi di pannelli e impianti
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta proprietari, aziende, installatori, manutentori, amministratori e piloti drone a gestire richieste legate a lavori drone fotovoltaico.
          ...
          <div className="mt-8">
            <Link href="/register">
              <button className="rounded-xl bg-green-500 px-6 py-3 font-semibold text-black transition hover:bg-green-400">
                Cerca un pilota per fotovoltaico
              </button>
            </Link>
          </div>
        </div>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Un impianto fotovoltaico installato in alto può essere difficile da osservare da terra, specialmente quando bisogna documentare sporco, ombre, pannelli danneggiati o accessi. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              ...
              <li>✅ documentazione impianti su tetto</li>
              <li>✅ riprese di coperture industriali</li>
              <li>✅ verifica visiva dopo maltempo</li>
              <li>✅ foto per manutenzione</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per lavori drone fotovoltaico
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per controllare visivamente un impianto fotovoltaico su capannone. Vorrei foto dei pannelli, delle file, dei bordi della copertura e delle zone con sporco evidente.”
            </p>
          </div>
