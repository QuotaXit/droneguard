...
export const metadata = {
  title: "Lavoro drone danni maltempo | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone danni maltempo su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per documentazione visiva di danni da maltempo su tetti, facciate, pannelli, capannoni, gronde, terreni, alberi, recinzioni e strutture esterne indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Tegole spostate, lamiere piegate e coperture danneggiate",
  "Grandine su pannelli, lucernari e strutture esterne",
  "Alberi caduti, recinzioni e aree allagate",
  "Foto per tecnici, manutentori e assicurazione",
  "Panoramiche prima di un intervento urgente",
...
const approfondimenti = [
  "Dopo un temporale forte il cliente può dover capire cosa è successo senza salire sul tetto o entrare in aree pericolose. Le immagini servono per decidere i passi successivi.",
  "Il pilota può documentare i danni visibili dall'alto, evidenziare le zone più colpite e consegnare materiale utile per descrivere il problema a chi dovrà intervenire.",
...
const faqs = [
  { q: "Il drone può aiutare dopo il maltempo?", a: "Sì, può aiutare a documentare danni visibili, ma non sostituisce verifiche tecniche, perizie ufficiali o controlli di sicurezza." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Danni maltempo con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per documentare danni da vento, grandine e pioggia
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, proprietari, aziende, amministratori, assicurazioni, tecnici, imprese e clienti che devono raccogliere prove visive dopo un evento meteo a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca documentazione visiva di danni da maltempo su tetti, facciate, pannelli, capannoni, gronde, terreni, alberi, recinzioni e strutture esterne e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone dopo una grandinata. Vorrei foto del tetto, dei pannelli fotovoltaici, delle gronde e del giardino per capire i danni visibili e mandare tutto all'assicurazione.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone danni maltempo
          </h2>
