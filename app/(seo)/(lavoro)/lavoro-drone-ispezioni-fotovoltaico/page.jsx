...
export const metadata = {
  title: "Lavoro drone ispezioni fotovoltaico | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone ispezioni fotovoltaico su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per controlli visivi di pannelli fotovoltaici, campi solari, impianti su tetto, strutture di supporto, sporco, ombreggiamenti, danni e accessi indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Pannelli su tetti civili e industriali",
  "Campi fotovoltaici e file di moduli",
  "Sporco, rotture, ombre e ostacoli visibili",
  "Strutture di supporto e accessi",
  "Foto per manutenzione e confronto tecnico",
...
const approfondimenti = [
  "Un impianto fotovoltaico può trovarsi su una copertura difficile da raggiungere o su un terreno ampio. Il cliente vuole capire se ci sono danni visibili o problemi da mostrare a un tecnico.",
  "Il pilota può fornire una panoramica dell'impianto, immagini per stringhe o settori e materiale utile al manutentore, chiarendo se effettua solo controllo visivo o anche termografia.",
...
const faqs = [
  { q: "Tutti i piloti possono fare ispezioni fotovoltaiche?", a: "Per foto e video visivi può bastare un servizio base se fattibile. Per termografia servono attrezzatura e competenze specifiche, da dichiarare chiaramente." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Richieste drone per impianti fotovoltaici
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per ispezioni fotovoltaico e pannelli solari
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, aziende, manutentori, proprietari, tecnici fotovoltaico e clienti che vogliono documentare lo stato dell'impianto a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca controlli visivi di pannelli fotovoltaici, campi solari, impianti su tetto, strutture di supporto, sporco, ombreggiamenti, danni e accessi e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per controllare un impianto fotovoltaico su capannone. Vorrei foto dei pannelli, della copertura, dei bordi e di eventuali danni visibili dopo una grandinata.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone ispezioni fotovoltaico
          </h2>
