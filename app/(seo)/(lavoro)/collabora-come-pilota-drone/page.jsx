...
export const metadata = {
  title: "Collabora come pilota drone | DroneGuard",
  description:
    "Collabora come pilota drone su DroneGuard. Registrati, trova richieste di clienti e candidati a lavori con drone per ispezioni, riprese, immobili, cantieri e aziende."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Collabora con DroneGuard
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Collabora come pilota drone e candidati alle richieste dei clienti
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone che vogliono aumentare le possibilità di ricevere richieste a gestire richieste legate a collaborare come pilota drone.
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Per collaborare bene non basta avere il drone: servono comunicazione chiara, disponibilità, rispetto delle regole, valutazione dei rischi e capacità di consegnare materiale utile. Una pagina SEO dedicata permette di spiegare in modo
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per collaborare come pilota drone
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Pilota drone disponibile a collaborare per richieste di ispezione, riprese e sopralluoghi. Posso valutare il lavoro, indicare tempi e consegnare foto e video in formato digitale.”
            </p>
          </div>
