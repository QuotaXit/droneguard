...
export const metadata = {
  title: "Lavori drone edilizia | DroneGuard",
  description:
    "Lavori drone edilizia: trova piloti per cantieri, tetti, facciate, coperture, grondaie, stato avanzamento lavori e documentazione fotografica dall'alto."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Drone per edilizia e cantieri
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavori drone edilizia: richieste per cantieri, tetti e facciate
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta imprese edili, direttori lavori, tecnici, geometri, amministratori e piloti drone a gestire richieste legate a lavori drone edilizia.
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Nel settore edile spesso bisogna documentare parti alte, aree estese, accessi difficili e stato dei lavori senza interrompere continuamente le attività in corso. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              ...
              <li>✅ controllo facciate</li>
              <li>✅ ispezione tetti</li>
              <li>✅ documentazione SAL</li>
              <li>✅ foto per preventivi edili</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per lavori drone edilizia
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per documentare lo stato di avanzamento di un cantiere e controllare alcune zone alte della facciata. Servono foto ordinate e video panoramico dell'area.”
            </p>
          </div>
