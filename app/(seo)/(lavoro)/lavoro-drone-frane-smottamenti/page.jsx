...
export const metadata = {
  title: "Lavoro drone frane smottamenti | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone frane smottamenti su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per riprese e foto aeree di frane, smottamenti, versanti, scarpate, terreni instabili, strade danneggiate e aree difficili o rischiose da raggiungere indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Frane e smottamenti su terreni privati",
  "Scarpate, pendii e versanti instabili",
  "Strade, muri e recinzioni danneggiate",
  "Foto per tecnici e geologi",
  "Panoramiche senza avvicinarsi a zone rischiose",
...
const approfondimenti = [
  "Dopo piogge intense o cedimenti, avvicinarsi a un versante può essere rischioso. Il cliente può aver bisogno di immagini per capire l'estensione del problema.",
  "Il pilota può documentare la zona da distanza sicura, senza sostituire geologi o tecnici, e consegnare materiale utile a chi valuterà l intervento.",
...
const faqs = [
  { q: "Il drone può essere utile per frane e smottamenti?", a: "Sì, può fornire una vista dall'alto senza entrare subito nell'area rischiosa. La valutazione tecnica resta competenza di professionisti qualificati." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Documentazione drone per dissesto
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per frane, smottamenti e versanti instabili
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, tecnici, geologi, comuni, proprietari, imprese, amministratori e clienti che devono osservare una zona potenzialmente pericolosa a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca riprese e foto aeree di frane, smottamenti, versanti, scarpate, terreni instabili, strade danneggiate e aree difficili o rischiose da raggiungere e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per riprese di uno smottamento vicino a una strada privata. Vorrei foto dall'alto del versante, della scarpata e della zona interessata dal cedimento.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone frane smottamenti
          </h2>
