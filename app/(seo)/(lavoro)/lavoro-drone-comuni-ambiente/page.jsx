...
export const metadata = {
  title: "Lavoro drone comuni ambiente | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone comuni ambiente su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per documentazione visiva per comuni, aree verdi, rifiuti abbandonati, corsi d'acqua, parchi, strade, frane, litorali, eventi pubblici e monitoraggio del territorio indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Aree verdi, parchi e zone periferiche",
  "Rifiuti abbandonati e degrado visibile",
  "Corsi d'acqua, fossi e argini",
  "Strade, piazzali e aree pubbliche",
  "Foto per segnalazioni e report interni",
...
const approfondimenti = [
  "Un comune o un'associazione può voler documentare una situazione da valutare, un'area da ripulire, un tratto di territorio da controllare o l'esito di un intervento.",
  "Il pilota può fornire immagini panoramiche e dettagli visibili, rispettando regole, privacy, sicurezza e eventuali autorizzazioni necessarie.",
...
const faqs = [
  { q: "Un comune può cercare un pilota drone?", a: "Sì, può pubblicare una richiesta o usare DroneGuard per trovare piloti disponibili a documentare aree e situazioni specifiche." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Drone per territorio e amministrazioni locali
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per comuni, ambiente e territorio
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, comuni, associazioni, tecnici comunali, enti locali, protezione civile, cittadini e realtà che vogliono documentare situazioni territoriali a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca documentazione visiva per comuni, aree verdi, rifiuti abbandonati, corsi d'acqua, parchi, strade, frane, litorali, eventi pubblici e monitoraggio del territorio e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per documentare un'area comunale con rifiuti abbandonati e vegetazione alta. Servono foto dall'alto per capire estensione e punti di accesso.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone comuni ambiente
          </h2>
