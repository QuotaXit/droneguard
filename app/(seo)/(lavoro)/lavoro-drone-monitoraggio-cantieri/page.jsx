...
export const metadata = {
  title: "Lavoro drone monitoraggio cantieri | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone monitoraggio cantieri su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per monitoraggio visivo di cantieri, stato avanzamento lavori, aree di scavo, coperture, facciate, ponteggi, viabilità interna e documentazione periodica indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Foto periodiche dello stato lavori",
  "Panoramiche di cantiere e aree di deposito",
  "Scavi, strutture, coperture e accessi",
  "Materiale per report interni e committenti",
  "Confronto visivo tra fasi diverse",
...
const approfondimenti = [
  "Un'impresa o un committente può voler seguire l avanzamento senza basarsi solo su foto sparse, soprattutto quando il cantiere è grande o cambia settimana dopo settimana.",
  "Il pilota può proporre riprese da posizioni simili nel tempo, consegne ordinate per data e attenzione a sicurezza, spazi e presenza di persone.",
...
const faqs = [
  { q: "Si possono creare incarichi ricorrenti per cantieri?", a: "Sì, il cliente può indicare frequenza desiderata e obiettivo. Pilota e cliente potranno poi accordarsi su tempi, modalità e consegne." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          ...
          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per monitoraggio cantieri e avanzamento lavori
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, imprese edili, direttori lavori, coordinatori sicurezza, committenti, tecnici e aziende che seguono cantieri in più fasi a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca monitoraggio visivo di cantieri, stato avanzamento lavori, aree di scavo, coperture, facciate, ponteggi, viabilità interna e documentazione periodica e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per monitorare un cantiere ogni due settimane. Servono foto panoramiche delle aree di lavoro, dei depositi, degli accessi e dello stato avanzamento lavori.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone monitoraggio cantieri
          </h2>
