...
export const metadata = {
  title: "Clienti cercano piloti drone | DroneGuard",
  description:
    "Pagina per clienti che cercano piloti drone in Italia. Pubblica un lavoro su DroneGuard e ricevi candidature per ispezioni, riprese, cantieri, immobili e fotovoltaico."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Clienti e richieste per piloti drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Clienti cercano piloti drone: pubblica la richiesta su DroneGuard
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta clienti, aziende, amministratori, tecnici, proprietari e professionisti a gestire richieste legate a clienti che cercano piloti drone.
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Molti clienti hanno bisogno di immagini dall'alto ma non sanno quale pilota contattare, che informazioni preparare o come spiegare il lavoro da svolgere. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ ispezioni di tetti e coperture</li>
              <li>✅ riprese aeree per immobili</li>
              <li>✅ monitoraggio di cantieri</li>
              <li>✅ foto e video per attività commerciali</li>
              <li>✅ controlli visivi di impianti fotovoltaici</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per clienti che cercano piloti drone
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per documentare dall'alto la copertura di un capannone e alcune grondaie. Vorrei foto chiare, video panoramico e disponibilità a inviare il materiale al tecnico incaricato.”
            </p>
          </div>
