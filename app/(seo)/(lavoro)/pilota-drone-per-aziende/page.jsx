...
export const metadata = {
  title: "Pilota drone per aziende | DroneGuard",
  description:
    "Cerchi un pilota drone per aziende? Con DroneGuard puoi trovare professionisti per ispezioni, foto, video, cantieri, capannoni, immobili, impianti e documentazione dall'alto."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Servizi drone per aziende
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Pilota drone per aziende: trova un professionista per foto, video e ispezioni
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta aziende, imprese edili, industrie, agenzie, attività commerciali e responsabili tecnici a gestire richieste legate a pilota drone per aziende.
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Un'azienda può avere esigenze molto diverse: promozione, controllo visivo, documentazione tecnica, archiviazione immagini, monitoraggio lavori o materiale da condividere con fornitori. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              ...
              <li>✅ controlli di capannoni</li>
              <li>✅ documentazione di cantieri</li>
              <li>✅ video per attività commerciali</li>
              <li>✅ ispezioni di coperture e impianti</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per pilota drone per aziende
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Azienda cerca pilota drone per riprese esterne dello stabilimento e controllo visivo della copertura. Servono foto panoramiche, dettagli di alcune zone e video breve per archivio interno.”
            </p>
          </div>
