...
export const metadata = {
  title: "Incarichi drone per professionisti | DroneGuard",
  description:
    "Trova o pubblica richieste per incarichi drone per professionisti su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per incarichi drone per professionisti che lavorano con edilizia, immobili, rilievi, cantieri, aziende, turismo, ambiente, documentazione visiva e riprese promozionali indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Richieste tecniche e commerciali",
  "Servizi per imprese, studi e amministratori",
  "Riprese, ispezioni e documentazione",
  "Collaborazioni con professionisti del territorio",
  "Materiale ordinato e riutilizzabile",
...
const approfondimenti = [
  "Un professionista cerca spesso un supporto affidabile, non solo qualcuno che voli. Vuole sapere tempi, consegna, metodo e limiti del servizio.",
  "Il pilota può distinguersi con comunicazione chiara, esempi di lavori, attenzione alla sicurezza e capacità di organizzare le immagini in modo utile al cliente.",
...
const faqs = [
  { q: "DroneGuard è solo per piccoli lavori?", a: "No. Può essere usato anche per richieste professionali, collaborazioni e incarichi più strutturati, sempre da valutare caso per caso." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Incarichi professionali con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Incarichi drone per professionisti, tecnici e aziende
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone professionali, tecnici, aziende, agenzie, committenti, amministratori, imprese e clienti che cercano servizi più strutturati a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca incarichi drone per professionisti che lavorano con edilizia, immobili, rilievi, cantieri, aziende, turismo, ambiente, documentazione visiva e riprese promozionali e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone professionale per collaborazione con studio tecnico. Servono riprese per cantieri, tetti e facciate, con consegna ordinata per relazione e preventivi.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per incarichi drone per professionisti
          </h2>
