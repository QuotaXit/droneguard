...
export const metadata = {
  title: "Lavoro drone stabilimenti balneari | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone stabilimenti balneari su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per riprese aeree per stabilimenti balneari, lidi, spiagge attrezzate, chioschi, ristoranti sul mare, eventi estivi e promozione turistica indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Stabilimenti, ombrelloni e servizi in spiaggia",
  "Chioschi, ristoranti e aree relax",
  "Eventi al tramonto e attività estive",
  "Video promozionali per social",
  "Panoramiche del litorale e degli accessi",
...
const approfondimenti = [
  "Uno stabilimento vuole mostrare posizione, ordine, servizi, mare e atmosfera. Le riprese aeree possono dare un impatto immediato a sito, social e campagne.",
  "Il pilota deve valutare persone presenti, orari, sicurezza, privacy, vento e regole locali, proponendo riprese in momenti adatti e non invasivi.",
...
const faqs = [
  { q: "Si può volare con drone vicino a spiagge e lidi?", a: "Dipende dalla zona, dalla presenza di persone, dalle regole applicabili e dalla valutazione del pilota. La richiesta va sempre verificata prima del servizio." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Riprese drone per lidi e spiagge
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per stabilimenti balneari, spiagge e lidi
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, stabilimenti balneari, ristoranti, agenzie turistiche, comuni costieri, organizzatori eventi e attività stagionali a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca riprese aeree per stabilimenti balneari, lidi, spiagge attrezzate, chioschi, ristoranti sul mare, eventi estivi e promozione turistica e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per riprese di uno stabilimento balneare prima dell'apertura al pubblico. Servono immagini degli ombrelloni, del ristorante, della spiaggia e del mare.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone stabilimenti balneari
          </h2>
