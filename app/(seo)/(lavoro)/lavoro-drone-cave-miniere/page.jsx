...
export const metadata = {
  title: "Lavoro drone cave miniere | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone cave miniere su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per riprese e documentazione aerea di cave, miniere, piazzali, cumuli di materiale, fronti di scavo, piste interne, depositi e aree produttive indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Cave, fronti di scavo e piste interne",
  "Cumuli di materiale e piazzali",
  "Aree di deposito e zone operative",
  "Foto periodiche per confronto visivo",
  "Materiale per tecnici e report aziendali",
...
const approfondimenti = [
  "Le aree estrattive sono spesso ampie e difficili da leggere da terra. Il cliente può voler documentare volumi, accessi, fronti di scavo o evoluzione dell'area nel tempo.",
  "Il pilota può produrre panoramiche, immagini per settori e, se qualificato, supportare attività di rilievo o calcolo volumetrico da concordare con i tecnici.",
...
const faqs = [
  { q: "I lavori in cava richiedono attenzione particolare?", a: "Sì. Servono valutazione di sicurezza, autorizzazioni, coordinamento con l'azienda e attenzione a mezzi, persone, polvere e aree operative." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Lavori drone per aree estrattive
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per cave, miniere, piazzali e volumi
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, aziende estrattive, tecnici, responsabili sicurezza, imprese, geometri e clienti che devono documentare aree ampie a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca riprese e documentazione aerea di cave, miniere, piazzali, cumuli di materiale, fronti di scavo, piste interne, depositi e aree produttive e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per documentare una cava e alcuni cumuli di materiale. Servono foto dall'alto del piazzale, delle piste interne e delle zone di deposito.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone cave miniere
          </h2>
