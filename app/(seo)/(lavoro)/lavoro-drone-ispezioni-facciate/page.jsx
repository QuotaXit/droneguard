...
export const metadata = {
  title: "Lavoro drone ispezioni facciate | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone ispezioni facciate su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per controlli visivi di facciate, prospetti, frontalini, balconi, cornicioni, rivestimenti, fessure e distacchi visibili indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Facciate condominiali e prospetti laterali",
  "Balconi, frontalini, cornicioni e sottobalconi",
  "Crepe, macchie, distacchi e zone deteriorate",
  "Rivestimenti, cappotti, intonaci e giunti",
  "Materiale per tecnici, assemblee e preventivi",
...
const approfondimenti = [
  "Una facciata può presentare distacchi, crepe, parti ammalorate o macchie che non si vedono bene da strada. Il cliente vuole capire cosa mostrare a un tecnico senza organizzare subito un ponteggio.",
  "Il pilota può raccogliere immagini per lato, evitare riprese inutili, mostrare punti critici e consegnare un materiale ordinato che faciliti il confronto tra cliente e professionista.",
...
const faqs = [
  { q: "Il drone è utile per lavori su facciate?", a: "Sì, può essere utile per documentare visivamente zone alte o difficili da osservare, sempre rispettando sicurezza, privacy, condizioni di volo e limiti operativi." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Lavori drone per facciate e prospetti
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per ispezioni facciate: richieste per piloti e tecnici
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, amministratori, tecnici, condomini, imprese di ristrutturazione e proprietari che vogliono documentare una facciata a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca controlli visivi di facciate, prospetti, frontalini, balconi, cornicioni, rivestimenti, fessure e distacchi visibili e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per documentare la facciata di un condominio. Vorrei foto dei balconi, dei frontalini, dei cornicioni e delle zone dove l'intonaco sembra rovinato, per parlarne con il tecnico.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone ispezioni facciate
          </h2>
