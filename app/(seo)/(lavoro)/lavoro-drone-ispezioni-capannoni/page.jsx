...
export const metadata = {
  title: "Lavoro drone ispezioni capannoni | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone ispezioni capannoni su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per ispezioni visive di capannoni, magazzini, coperture industriali, pannelli sandwich, lamiere, lucernari, gronde e aree logistiche indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Coperture industriali in lamiera o pannelli",
  "Lucernari, gronde e pluviali di grandi superfici",
  "Zone con infiltrazioni o danni da vento",
  "Aree esterne, piazzali e accessi",
  "Documentazione per manutenzione aziendale",
...
const approfondimenti = [
  "Un'azienda può avere una copertura ampia e difficile da controllare, infiltrazioni sopra un'area produttiva, lucernari sporchi o danni dopo un evento meteo.",
  "Il pilota può documentare grandi superfici con foto panoramiche e riprese per settore, rendendo più semplice individuare i punti da mostrare a manutentori e tecnici.",
...
const faqs = [
  { q: "Ci sono richieste di lavoro drone per capannoni?", a: "Sì, aziende e proprietari possono cercare piloti per controlli visivi di coperture industriali, piazzali, magazzini e strutture produttive." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Lavori drone per aziende e capannoni
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per ispezioni capannoni industriali e magazzini
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, aziende, responsabili manutenzione, proprietari di capannoni, imprese edili, tecnici e facility manager a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca ispezioni visive di capannoni, magazzini, coperture industriali, pannelli sandwich, lamiere, lucernari, gronde e aree logistiche e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per ispezionare la copertura di un capannone. Servono foto delle lamiere, dei lucernari, delle gronde e dei punti dove in magazzino abbiamo notato infiltrazioni.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone ispezioni capannoni
          </h2>
