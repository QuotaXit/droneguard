...
export const metadata = {
  title: "Lavoro drone ispezioni condomini | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone ispezioni condomini su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per controlli visivi di condomini, coperture, facciate, balconi, lastrici, cornicioni, antenne, terrazzi e parti comuni difficili da osservare indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Tetti condominiali e lastrici solari",
  "Facciate, balconi, frontalini e cornicioni",
  "Antenne, canne fumarie e lucernari",
  "Gronde, pluviali e zone con infiltrazioni",
  "Foto da condividere con assemblea e tecnici",
...
const approfondimenti = [
  "L amministratore può dover spiegare un problema ai condomini, documentare lo stato di parti comuni o chiedere preventivi per lavori su tetto e facciata.",
  "Il pilota può fornire una panoramica ordinata dell'edificio, dividere le immagini per lato, evitare confusione e aiutare l amministratore ad avere materiale più chiaro.",
...
const faqs = [
  { q: "Un condominio può pubblicare un lavoro per pilota drone?", a: "Sì. La richiesta può essere pubblicata da amministratore, tecnico o proprietario, indicando edificio, zona, obiettivo delle immagini e punti da documentare." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Incarichi drone per condomini
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per ispezioni condomini: tetti, facciate e balconi
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, amministratori di condominio, consiglieri, tecnici, imprese e proprietari che devono raccogliere immagini prima di una decisione a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca controlli visivi di condomini, coperture, facciate, balconi, lastrici, cornicioni, antenne, terrazzi e parti comuni difficili da osservare e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per un condominio di quattro piani. Dobbiamo controllare tetto, cornicioni, balconi e pluviali prima di chiedere preventivi di manutenzione ordinaria e straordinaria.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone ispezioni condomini
          </h2>
