...
export const metadata = {
  title: "Offerte drone per freelance | DroneGuard",
  description:
    "Trova o pubblica richieste per offerte drone per freelance su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per offerte e richieste per freelance drone che cercano incarichi in ispezioni, riprese aeree, immobili, cantieri, turismo, agricoltura e documentazione tecnica indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Incarichi una tantum e collaborazioni ricorrenti",
  "Richieste locali vicino al pilota",
  "Servizi per aziende e privati",
  "Candidature con descrizione chiara",
  "Contatto diretto tra cliente e professionista",
...
const approfondimenti = [
  "Il cliente vuole trovare qualcuno disponibile senza perdere tempo a cercare contatti sparsi. Il freelance vuole leggere richieste concrete e candidarsi solo a quelle adatte.",
  "Il pilota freelance può presentare esperienza, zona di lavoro, servizi offerti e modalità di consegna, trasformando una candidatura in un primo contatto serio.",
...
const faqs = [
  { q: "Un pilota freelance può usare DroneGuard?", a: "Sì. Può registrarsi come pilota, leggere annunci disponibili e candidarsi alle richieste compatibili con zona, competenze e attrezzatura." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Freelance drone e nuove richieste
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Offerte drone per freelance: trova incarichi e candidati
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone freelance, professionisti indipendenti, clienti, aziende, agenzie, amministratori e privati che vogliono trovare un operatore disponibile a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca offerte e richieste per freelance drone che cercano incarichi in ispezioni, riprese aeree, immobili, cantieri, turismo, agricoltura e documentazione tecnica e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Sono un cliente e cerco un freelance drone per foto e video di un edificio. Vorrei ricevere candidature da piloti disponibili in zona, con indicazione dei servizi offerti.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per offerte drone per freelance
          </h2>
