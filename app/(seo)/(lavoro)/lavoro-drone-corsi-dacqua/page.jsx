...
export const metadata = {
  title: "Lavoro drone corsi d'acqua | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone corsi d'acqua su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per documentazione aerea di fossi, canali, corsi d'acqua, argini, ostruzioni, vegetazione, erosioni, ponticelli, aree allagate e punti critici indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Fossi e canali ostruiti",
  "Argini, erosioni e vegetazione invasiva",
  "Ponticelli, attraversamenti e scarichi",
  "Zone allagate dopo piogge intense",
  "Foto per segnalazioni e manutenzione",
...
const approfondimenti = [
  "Un fosso ostruito o un argine rovinato può creare problemi di allagamento. Le immagini dall'alto aiutano a capire estensione, accessi e punti da segnalare.",
  "Il pilota può seguire il tracciato visibile, realizzare panoramiche progressive e mostrare i punti in cui vegetazione o detriti impediscono il normale deflusso.",
...
const faqs = [
  { q: "Si possono pubblicare lavori drone per corsi d'acqua?", a: "Sì, indicando tratto da osservare, accessi, obiettivo delle immagini e eventuali criticità visibili da documentare." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per controllare un fosso vicino a un terreno agricolo. Vorrei foto dei punti ostruiti, dell'acqua ferma, degli argini e degli accessi per eventuale pulizia.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone corsi d'acqua
          </h2>
