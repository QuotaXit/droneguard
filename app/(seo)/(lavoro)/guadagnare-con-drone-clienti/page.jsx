...
export const metadata = {
  title: "Guadagnare con drone clienti | DroneGuard",
  description:
    "Trova o pubblica richieste per guadagnare con drone clienti su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per opportunità per guadagnare con il drone attraverso richieste di clienti per ispezioni, riprese, immobili, cantieri, aziende, turismo e documentazione visiva indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Richieste di clienti privati e aziende",
  "Servizi concreti con foto e video",
  "Candidature mirate invece di pubblicità generica",
  "Possibili collaborazioni nel territorio",
  "Crescita graduale del portafoglio lavori",
...
const approfondimenti = [
  "Per guadagnare non basta possedere un drone: servono richieste reali, comunicazione chiara, servizi utili e capacità di risolvere un problema del cliente.",
  "Il pilota può usare DroneGuard per candidarsi a lavori, capire cosa chiedono i clienti e costruire esperienza su servizi specifici.",
...
const faqs = [
  { q: "Si può guadagnare con il drone?", a: "Sì, ma dipende da competenze, zona, domanda, qualità del servizio, comunicazione e capacità di trovare clienti reali. DroneGuard aiuta nel contatto iniziale." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Clienti e lavori per piloti drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Guadagnare con il drone trovando clienti e lavori reali
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, freelance, operatori video, tecnici, professionisti locali e persone che vogliono trasformare il drone in un servizio utile ai clienti a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca opportunità per guadagnare con il drone attraverso richieste di clienti per ispezioni, riprese, immobili, cantieri, aziende, turismo e documentazione visiva e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Sono un pilota drone e cerco clienti per ispezioni, foto immobiliari e riprese promozionali. Voglio candidarmi solo a richieste nella mia zona e spiegare bene cosa posso consegnare.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per guadagnare con drone clienti
          </h2>
