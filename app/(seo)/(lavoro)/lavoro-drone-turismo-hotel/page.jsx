...
export const metadata = {
  title: "Lavoro drone turismo hotel | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone turismo hotel su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per riprese aeree per hotel, B&B, resort, agriturismi, campeggi, ristoranti, location, panorami, piscine, giardini e percorsi turistici indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Hotel, resort, B&B e agriturismi",
  "Piscine, giardini, terrazze e viste panoramiche",
  "Accessi, parcheggi e contesto naturale",
  "Video per sito web e social",
  "Riprese da abbinare a contenuti interni",
...
const approfondimenti = [
  "Una struttura turistica spesso vende esperienza, posizione e atmosfera. Le immagini aeree possono mostrare ciò che una foto da terra non riesce a raccontare.",
  "Il pilota può creare clip brevi, riprese di apertura, panoramiche della struttura e materiale da consegnare a chi cura il sito o i social.",
...
const faqs = [
  { q: "Gli hotel possono cercare piloti drone su DroneGuard?", a: "Sì. Possono pubblicare una richiesta con luogo, tipo di riprese, obiettivo marketing, orari preferiti e materiale desiderato." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Riprese drone per hotel e turismo
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per turismo, hotel e strutture ricettive
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, hotel, strutture ricettive, agenzie turistiche, proprietari, social media manager e attività che vogliono migliorare la comunicazione online a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca riprese aeree per hotel, B&B, resort, agriturismi, campeggi, ristoranti, location, panorami, piscine, giardini e percorsi turistici e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per realizzare riprese esterne di un hotel. Vorrei mostrare piscina, giardino, ingresso, parcheggio e vista panoramica per aggiornare sito e profili social.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone turismo hotel
          </h2>
