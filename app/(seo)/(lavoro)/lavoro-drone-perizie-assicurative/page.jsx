...
export const metadata = {
  title: "Lavoro drone perizie assicurative | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone perizie assicurative su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per raccolta immagini e video per danni, sinistri, coperture, immobili, aree esterne, impianti e strutture da mostrare a tecnici, periti o assicurazioni indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Foto dei danni visibili su tetti e coperture",
  "Video panoramici dell'area interessata",
  "Immagini ordinate per lato e punto critico",
  "Materiale da inviare a periti o assicurazioni",
  "Documentazione prima di riparazioni urgenti",
...
const approfondimenti = [
  "Quando c è un danno il cliente vuole spesso raccogliere immagini prima che la situazione cambi. Il drone può aiutare a vedere punti alti o aree estese.",
  "Il pilota deve essere chiaro: fornisce documentazione visiva, non una perizia assicurativa ufficiale, a meno che non abbia anche qualifiche professionali specifiche.",
...
const faqs = [
  { q: "Le immagini del drone valgono come perizia?", a: "Le immagini possono supportare una pratica, ma la perizia resta compito del professionista o del perito incaricato. DroneGuard mette in contatto cliente e pilota." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Documentazione drone per assicurazioni
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per documentazione assicurativa e perizie visive
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, proprietari, aziende, amministratori, periti, tecnici e clienti che vogliono documentare un danno in modo ordinato a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca raccolta immagini e video per danni, sinistri, coperture, immobili, aree esterne, impianti e strutture da mostrare a tecnici, periti o assicurazioni e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per documentare danni al tetto dopo vento forte. Mi servono foto ordinate delle parti visibili, da inviare al tecnico e poi eventualmente all'assicurazione.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone perizie assicurative
          </h2>
