...
export const metadata = {
  title: "Lavoro drone freelance | DroneGuard",
  description:
    "Lavoro drone freelance: trova clienti, candidature e richieste per servizi con drone. DroneGuard collega piloti drone freelance con aziende e privati."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          ...
          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone freelance: trova richieste da clienti e aziende
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone freelance, videomaker, tecnici e operatori indipendenti a gestire richieste legate a lavoro drone freelance.
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Chi lavora come freelance deve farsi trovare, spiegare bene i propri servizi e valutare ogni richiesta in base a distanza, fattibilità, meteo, sicurezza e materiale richiesto. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ servizi fotografici esterni</li>
              <li>✅ riprese promozionali</li>
              <li>✅ ispezioni visive</li>
              <li>✅ sopralluoghi rapidi</li>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per lavoro drone freelance
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Sono un pilota drone freelance disponibile per riprese immobiliari, controlli visivi e video promozionali. Valuto richieste nella mia zona e preparo preventivi in base al lavoro.”
            </p>
          </div>
