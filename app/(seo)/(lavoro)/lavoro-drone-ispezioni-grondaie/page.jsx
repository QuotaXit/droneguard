...
export const metadata = {
  title: "Lavoro drone ispezioni grondaie | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone ispezioni grondaie su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per ispezioni visive di grondaie, pluviali, canali di scolo, scarichi ostruiti, accumuli di foglie, raccordi e bordi di copertura indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Gronde sporche o ostruite",
  "Pluviali scollegati o danneggiati",
  "Raccordi tra tetto e canale di scolo",
  "Accumuli di foglie, fango o detriti",
  "Foto prima e dopo manutenzione",
...
const approfondimenti = [
  "Il cliente può notare gocciolamenti, acqua che scende male, infiltrazioni vicino ai muri o zone bagnate dopo la pioggia. Prima di chiamare una ditta può voler vedere dove si trova il problema.",
  "Il pilota può realizzare immagini dall'alto lungo il perimetro, mostrare i punti ostruiti, documentare i raccordi e aiutare il cliente a descrivere meglio il lavoro a chi eseguirà la pulizia.",
...
const faqs = [
  { q: "Si possono cercare lavori drone per controllare grondaie?", a: "Sì. Su DroneGuard il cliente può pubblicare una richiesta e il pilota può candidarsi se riesce a documentare gronde e pluviali in sicurezza." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Richieste drone per gronde e pluviali
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per ispezioni grondaie, pluviali e scarichi
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, manutentori, amministratori, proprietari, imprese di pulizia gronde e clienti che vogliono verificare un problema prima di intervenire a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca ispezioni visive di grondaie, pluviali, canali di scolo, scarichi ostruiti, accumuli di foglie, raccordi e bordi di copertura e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Ho bisogno di un pilota drone per vedere lo stato delle grondaie di una casa a due piani. Dopo la pioggia l'acqua scende male e vorrei foto dei canali, dei pluviali e dei punti pieni di foglie.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone ispezioni grondaie
          </h2>
