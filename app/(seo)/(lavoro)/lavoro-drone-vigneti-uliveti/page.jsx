...
export const metadata = {
  title: "Lavoro drone vigneti uliveti | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone vigneti uliveti su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per riprese e documentazione aerea di vigneti, uliveti, campi, filari, poderi, aziende agricole, irrigazione, confini e percorsi interni indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Vigneti, uliveti e filari",
  "Confini, strade interne e accessi",
  "Aree irrigate e zone con differenze visibili",
  "Foto promozionali per cantine e frantoi",
  "Materiale per controllo visivo del terreno",
...
const approfondimenti = [
  "Un'azienda agricola può voler controllare grandi superfici, mostrare la proprietà a clienti o documentare visivamente l'andamento dei filari e degli accessi.",
  "Il pilota può offrire panoramiche, riprese promozionali o documentazione ordinata del terreno, chiarendo se il servizio è solo visivo o agronomico-specialistico.",
...
const faqs = [
  { q: "Il drone può aiutare aziende agricole e cantine?", a: "Sì, per riprese promozionali e controlli visivi. Per analisi agronomiche servono competenze e sensori specifici da concordare." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Drone per agricoltura e aziende agricole
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per vigneti, uliveti e aziende agricole
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, agricoltori, aziende agricole, agronomi, cantine, frantoi, tecnici e proprietari che vogliono osservare o valorizzare i terreni a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca riprese e documentazione aerea di vigneti, uliveti, campi, filari, poderi, aziende agricole, irrigazione, confini e percorsi interni e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per riprese di vigneto e uliveto. Vorrei foto panoramiche, video dei filari, accessi e casale, da usare anche per sito e presentazione aziendale.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone vigneti uliveti
          </h2>
