...
export const metadata = {
  title: "Lavoro drone fotogrammetria | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone fotogrammetria su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per acquisizione immagini per fotogrammetria, ortofoto, modelli 3D, rilievi visivi, mappature di terreni, cantieri, coperture e aree da documentare indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Acquisizione immagini sovrapposte",
  "Ortofoto e modelli 3D quando concordati",
  "Terreni, cantieri e aree produttive",
  "Supporto a tecnici e professionisti",
  "Materiale da elaborare o consegnare al cliente",
...
const approfondimenti = [
  "Un tecnico può avere bisogno di immagini ordinate per ricostruire un'area, misurare visivamente lo stato di avanzamento o creare una base di lavoro più chiara.",
  "Il pilota può specificare se fornisce solo acquisizione immagini o anche elaborazione, indicando precisione attesa, limiti del servizio e dati necessari per il volo.",
...
const faqs = [
  { q: "I lavori di fotogrammetria sono adatti a tutti i piloti?", a: "No. Servono competenze, attrezzatura, pianificazione e chiarezza sulla consegna. Il pilota deve spiegare cosa può realmente fornire." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Incarichi drone per fotogrammetria
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per fotogrammetria: richieste e incarichi tecnici
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, tecnici, geometri, ingegneri, imprese, studi professionali e clienti che hanno bisogno di dati visivi più strutturati a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca acquisizione immagini per fotogrammetria, ortofoto, modelli 3D, rilievi visivi, mappature di terreni, cantieri, coperture e aree da documentare e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per acquisizione immagini fotogrammetriche di un terreno. Vorrei capire se è possibile ottenere materiale ordinato per ortofoto e supporto al tecnico incaricato.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone fotogrammetria
          </h2>
