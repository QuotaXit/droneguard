...
export const metadata = {
  title: "Lavoro drone rilievi topografici | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone rilievi topografici su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per rilievi topografici con drone, mappature di aree, terreni, cantieri, strade private, lotti, scavi, aree agricole e superfici da documentare indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Mappature di terreni e lotti",
  "Cantieri e aree di scavo",
  "Tracciati, strade private e piazzali",
  "Rilievi da affiancare al lavoro del tecnico",
  "Foto aeree e materiale elaborabile",
...
const approfondimenti = [
  "Chi deve progettare, vendere, controllare o documentare un'area può avere bisogno di una visione dall'alto più completa rispetto a un sopralluogo tradizionale.",
  "Il pilota può raccogliere immagini secondo un piano concordato, specificare limiti e modalità, e lavorare insieme al tecnico responsabile del rilievo.",
...
const faqs = [
  { q: "Un cliente può chiedere un rilievo topografico su DroneGuard?", a: "Sì, può pubblicare la richiesta. Il pilota dovrà chiarire se fornisce solo riprese, acquisizione dati o anche elaborazioni tecniche." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Rilievi e mappature con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per rilievi topografici e mappature di aree
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone specializzati, geometri, tecnici, imprese, proprietari di terreni, studi di progettazione e aziende che cercano dati visivi dall'alto a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca rilievi topografici con drone, mappature di aree, terreni, cantieri, strade private, lotti, scavi, aree agricole e superfici da documentare e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per rilievo visivo di un terreno agricolo e di una strada di accesso. Mi servono immagini dall'alto da condividere con il geometra per valutazioni preliminari.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone rilievi topografici
          </h2>
