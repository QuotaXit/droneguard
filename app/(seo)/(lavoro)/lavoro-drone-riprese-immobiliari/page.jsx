...
export const metadata = {
  title: "Lavoro drone riprese immobiliari | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone riprese immobiliari su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per foto e video aerei per immobili, ville, case in vendita, terreni, casali, attici, terrazzi, giardini, complessi residenziali e annunci immobiliari indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Ville, casali, rustici e case indipendenti",
  "Giardini, piscine, accessi e viste panoramiche",
  "Terreni, confini e contesto esterno",
  "Video per annunci e presentazioni immobiliari",
  "Foto coordinate con il servizio fotografico tradizionale",
...
const approfondimenti = [
  "Un immobile con spazi esterni, vista, terreno o posizione particolare può essere comunicato meglio con immagini aeree, soprattutto quando le foto da terra non spiegano bene il contesto.",
  "Il pilota può realizzare riprese pulite, movimenti semplici, inquadrature dall'alto e materiale utile ad agenzie e proprietari per completare l'annuncio.",
...
const faqs = [
  { q: "I piloti drone possono trovare lavori immobiliari?", a: "Sì. Agenzie e proprietari possono pubblicare richieste per foto e video aerei, mentre i piloti possono candidarsi indicando esperienza e tipo di materiale consegnabile." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Riprese immobiliari con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per riprese immobiliari: ville, case e proprietà
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, agenzie immobiliari, proprietari, home stager, fotografi, costruttori e clienti che vogliono valorizzare un immobile a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca foto e video aerei per immobili, ville, case in vendita, terreni, casali, attici, terrazzi, giardini, complessi residenziali e annunci immobiliari e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per riprese di una villa in vendita. Vorrei foto del giardino, della piscina, dell'accesso, della posizione rispetto al quartiere e qualche breve video panoramico.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone riprese immobiliari
          </h2>
