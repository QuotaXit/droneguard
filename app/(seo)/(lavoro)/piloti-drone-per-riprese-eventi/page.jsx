...
export const metadata = {
  title: "Piloti drone per riprese eventi | DroneGuard",
  description:
    "Trova o pubblica richieste per piloti drone per riprese eventi su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per riprese aeree per eventi, location, manifestazioni, inaugurazioni, raduni, matrimoni, attività sportive, feste private e contenuti promozionali indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Location eventi e spazi esterni",
  "Riprese prima dell'arrivo degli ospiti",
  "Panoramiche di allestimenti e aree",
  "Video brevi per social e promozione",
  "Materiale da integrare con videomaker a terra",
...
const approfondimenti = [
  "Un evento può aver bisogno di immagini di atmosfera, location e allestimenti. Spesso è meglio pianificare riprese in momenti con meno persone e maggiore controllo.",
  "Il pilota deve spiegare cosa si può riprendere, quando conviene farlo e quali limiti ci sono con persone presenti, privacy, sicurezza e regolamenti.",
...
const faqs = [
  { q: "È possibile usare il drone durante eventi con persone?", a: "Va valutato con grande attenzione. Sicurezza, distanze, autorizzazioni, privacy e presenza di persone possono limitare o impedire il volo." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Riprese eventi con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Piloti drone per riprese eventi, location e manifestazioni
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, organizzatori eventi, location, wedding planner, aziende, comuni, associazioni e clienti che vogliono immagini aeree di un evento a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca riprese aeree per eventi, location, manifestazioni, inaugurazioni, raduni, matrimoni, attività sportive, feste private e contenuti promozionali e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per riprese di una location evento prima dell'ingresso degli invitati. Vorrei clip degli allestimenti, del giardino, del parcheggio e della vista panoramica.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per piloti drone per riprese eventi
          </h2>
