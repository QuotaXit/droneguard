...
export const metadata = {
  title: "Lavoro drone ispezioni tetti | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone ispezioni tetti su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per ispezioni visive di tetti, tegole, coperture, colmi, scossaline, comignoli e punti difficili da controllare da terra indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Tetti in tegole, coppi o coperture miste",
  "Colmi, scossaline, canne fumarie e lucernari",
  "Zone con tegole rotte, spostate o mancanti",
  "Gronde, pluviali e raccordi laterali",
  "Foto e video per preventivi di manutenzione",
...
const approfondimenti = [
  "Un cliente può avere infiltrazioni interne, tegole spostate dopo vento forte, una copertura vecchia da controllare o la necessità di inviare immagini a un tecnico prima di far salire qualcuno sul tetto.",
  "Il pilota può proporre foto panoramiche, riprese ravvicinate dei punti visibili, video lenti dei lati della copertura e consegna ordinata del materiale per zona.",
...
const faqs = [
  { q: "Un pilota drone può lavorare su richieste di ispezione tetti?", a: "Sì, se il volo è fattibile e sicuro. Il cliente pubblica la richiesta, il pilota valuta zona, ostacoli, meteo, spazi e tipo di immagini da consegnare." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Lavori drone per tetti e coperture
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per ispezioni tetti: trova richieste e clienti
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, amministratori di condominio, proprietari, imprese edili, lattonieri, tecnici e clienti che devono controllare una copertura a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca ispezioni visive di tetti, tegole, coperture, colmi, scossaline, comignoli e punti difficili da controllare da terra e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per controllare il tetto di una villetta dopo il maltempo. Mi servono foto di tegole, gronde, comignoli e punti dove potrebbe entrare acqua, da mandare al tecnico per un preventivo.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone ispezioni tetti
          </h2>
