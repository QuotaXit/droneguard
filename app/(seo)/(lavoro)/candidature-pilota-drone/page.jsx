...
export const metadata = {
  title: "Candidature pilota drone | DroneGuard",
  description:
    "Candidature pilota drone: come rispondere alle richieste dei clienti su DroneGuard con informazioni chiare su servizi, disponibilità, zona, esperienza e consegna materiale."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Candidature per piloti drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Candidature pilota drone: rispondi alle richieste in modo chiaro
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone che vogliono presentarsi meglio ai clienti a gestire richieste legate a candidature pilota drone.
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Una candidatura generica rischia di non convincere il cliente. Serve spiegare cosa puoi fare, quando sei disponibile, che materiale consegni e quali limiti vanno valutati. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ risposta a un annuncio</li>
              <li>✅ presentazione del servizio</li>
              <li>✅ preventivo indicativo</li>
              <li>✅ descrizione attrezzatura</li>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per candidature pilota drone
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Buongiorno, sono disponibile per il sopralluogo con drone. Posso realizzare foto panoramiche, dettagli ravvicinati e video breve. Prima del volo valuterò meteo, sicurezza e area interessata.”
            </p>
          </div>
