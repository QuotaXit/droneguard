...
export const metadata = {
  title: "Lavoro drone sopralluoghi tecnici | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone sopralluoghi tecnici su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per sopralluoghi visivi con drone per edifici, aree esterne, coperture, terreni, cantieri, impianti e punti difficili da raggiungere indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Prima documentazione visiva di un problema",
  "Foto per preventivi e valutazioni preliminari",
  "Aree difficili da osservare da terra",
  "Supporto a tecnici e imprese",
  "Immagini ordinate per zona e priorità",
...
const approfondimenti = [
  "Molte richieste partono da un dubbio: una perdita, una crepa, una zona alta, un terreno o una copertura da capire meglio prima di spendere soldi in sopralluoghi più complessi.",
  "Il pilota può aiutare il cliente a trasformare un problema generico in una raccolta di immagini chiare, senza promettere diagnosi tecniche non di sua competenza.",
...
const faqs = [
  { q: "Il drone sostituisce un tecnico?", a: "No. Il drone può fornire documentazione visiva, ma valutazioni strutturali, perizie e diagnosi spettano a professionisti qualificati." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Ho bisogno di un sopralluogo visivo con drone su una copertura e su un'area esterna. Vorrei foto ordinate per capire cosa mostrare al tecnico e chiedere un preventivo più preciso.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone sopralluoghi tecnici
          </h2>
