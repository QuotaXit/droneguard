...
export const metadata = {
  title: "Richieste clienti piloti drone | DroneGuard",
  description:
    "Trova o pubblica richieste per richieste clienti piloti drone su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per richieste clienti per piloti drone in ispezioni, riprese, sopralluoghi, cantieri, immobili, fotovoltaico, turismo, aziende e lavori locali indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Annunci chiari con città e obiettivo",
  "Candidature da piloti interessati",
  "Servizi per privati e aziende",
  "Richieste tecniche e promozionali",
  "Primo contatto tramite piattaforma",
...
const approfondimenti = [
  "Chi cerca un pilota drone spesso non sa quali informazioni inserire. Una richiesta chiara permette ai piloti di capire subito se il lavoro è adatto.",
  "Il pilota deve rispondere in modo concreto, spiegando disponibilità, esperienza, consegna prevista e eventuali domande prima di confermare il servizio.",
...
const faqs = [
  { q: "Come devono essere scritte le richieste dei clienti?", a: "Devono indicare luogo, obiettivo, tipo di servizio, urgenza, punti da riprendere, eventuali ostacoli e materiale desiderato." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Richieste clienti per servizi drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Richieste clienti per piloti drone: pubblica o candidati
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta clienti che cercano un pilota, piloti che cercano lavoro, aziende, tecnici, proprietari, amministratori e professionisti del territorio a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca richieste clienti per piloti drone in ispezioni, riprese, sopralluoghi, cantieri, immobili, fotovoltaico, turismo, aziende e lavori locali e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone in provincia per ispezione tetto e riprese della proprietà. Indico zona, altezza, tipo di immagini richieste e motivo del controllo.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per richieste clienti piloti drone
          </h2>
