...
export const metadata = {
  title: "Lavori drone cantieri | DroneGuard",
  description:
    "Lavori drone cantieri: trova piloti per monitoraggio, foto periodiche, stato avanzamento lavori, sopralluoghi, documentazione di aree edili e video dall'alto."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Cantieri e monitoraggio
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavori drone cantieri: monitoraggio e documentazione dall'alto
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta imprese, direttori lavori, tecnici, committenti, coordinatori e piloti drone a gestire richieste legate a lavori drone cantieri.
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Un cantiere cambia rapidamente e spesso serve una memoria visiva ordinata per mostrare avanzamento, aree completate, zone critiche e organizzazione generale. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ foto periodiche del cantiere</li>
              <li>✅ video panoramici</li>
              <li>✅ controllo accessi e aree</li>
              <li>✅ documentazione SAL</li>
              <li>✅ sopralluoghi per committenti</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per lavori drone cantieri
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Impresa cerca pilota drone per foto mensili dello stato avanzamento lavori. Servono immagini dall'alto dell'area, dei fronti di lavoro e delle zone principali del cantiere.”
            </p>
          </div>
