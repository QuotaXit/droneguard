...
export const metadata = {
  title: "Lavori drone immobiliare | DroneGuard",
  description:
    "Lavori drone immobiliare per agenzie, proprietari e piloti. Trova richieste per foto e video di case, ville, terreni, rustici, hotel, capannoni e immobili in vendita."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Drone per immobiliare
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavori drone immobiliare: foto e video per valorizzare immobili
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta agenzie immobiliari, proprietari, home stager, investitori e piloti drone a gestire richieste legate a lavori drone immobiliare.
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Un annuncio immobiliare deve far capire posizione, accessi, esterni, giardino, vista, pertinenze e contesto: elementi che spesso da terra non si vedono bene. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ foto aeree di ville</li>
              <li>✅ video immobiliari</li>
              <li>✅ riprese di terreni</li>
              <li>✅ presentazione di case vacanza</li>
              <li>✅ documentazione di immobili di pregio</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per lavori drone immobiliare
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Agenzia immobiliare cerca pilota drone per foto e video di una villa con giardino. Servono riprese esterne, vista del terreno, ingresso, piscina e contesto della zona.”
            </p>
          </div>
