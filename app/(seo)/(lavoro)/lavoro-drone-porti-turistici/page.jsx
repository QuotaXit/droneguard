...
export const metadata = {
  title: "Lavoro drone porti turistici | DroneGuard",
  description:
    "Trova o pubblica richieste per lavoro drone porti turistici su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per foto e video aerei di porti turistici, marine, banchine, pontili, barche, servizi nautici, strutture sul mare e aree ricettive costiere indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Pontili, banchine e ormeggi",
  "Servizi nautici e aree di accoglienza",
  "Barche, yacht e cantieri nautici",
  "Video promozionali per turismo e nautica",
  "Panoramiche del contesto costiero",
...
const approfondimenti = [
  "Un porto turistico o una marina può voler mostrare ordine, servizi, posizione e collegamento con il territorio, usando immagini più forti rispetto alle riprese da terra.",
  "Il pilota deve valutare vento, spazi, persone, imbarcazioni, sicurezza, privacy e regole locali, proponendo orari e movimenti compatibili con l'area.",
...
const faqs = [
  { q: "Si possono fare riprese drone in porti turistici?", a: "Dipende dalle regole della zona, dagli spazi e dalla sicurezza. Il pilota deve valutare la fattibilità prima di accettare l'incarico." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Riprese drone per nautica e marine
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavoro drone per porti turistici, marine e aree nautiche
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, porti turistici, marine, cantieri nautici, agenzie turistiche, attività costiere e clienti che vogliono valorizzare strutture sul mare a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca foto e video aerei di porti turistici, marine, banchine, pontili, barche, servizi nautici, strutture sul mare e aree ricettive costiere e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per video promozionale di un porto turistico. Vorrei riprese di pontili, barche, servizi, ingresso e vista generale della marina.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per lavoro drone porti turistici
          </h2>
