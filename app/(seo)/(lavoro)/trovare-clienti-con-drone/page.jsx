...
export const metadata = {
  title: "Trovare clienti con drone | DroneGuard",
  description:
    "Trovare clienti con drone: idee e strumenti per piloti drone che vogliono ricevere richieste, candidarsi a lavori e proporre servizi a privati e aziende."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Clienti per piloti drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Trovare clienti con drone: come aumentare le richieste di lavoro
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, freelance, videomaker e operatori che cercano nuovi clienti a gestire richieste legate a trovare clienti con drone.
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Molti piloti pubblicano foto belle sui social, ma non sempre arrivano richieste concrete. Per lavorare serve intercettare bisogni reali e rispondere a problemi specifici. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ clienti immobiliari</li>
              <li>✅ clienti edili</li>
              <li>✅ aziende locali</li>
              <li>✅ amministratori di condominio</li>
              <li>✅ proprietari di impianti e coperture</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per trovare clienti con drone
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Pilota drone disponibile per clienti che hanno bisogno di foto, video o controlli visivi. Posso lavorare su immobili, cantieri, coperture, eventi e attività aziendali nella mia zona.”
            </p>
          </div>
