...
export const metadata = {
  title: "Piloti drone per lavori edili | DroneGuard",
  description:
    "Trova o pubblica richieste per piloti drone per lavori edili su DroneGuard. Clienti e piloti drone possono incontrarsi per servizi, ispezioni, riprese e lavori professionali."
}

const cards = [
  { title: "Per clienti", text: "Pubblica una richiesta per servizi drone per lavori edili, cantieri, ristrutturazioni, tetti, facciate, coperture, ponteggi, demolizioni, scavi e controlli visivi indicando luogo, obiettivo, urgenza e tipo di materiale che vuoi ricevere." },
...
const servizi = [
  "Cantieri edili e ristrutturazioni",
  "Tetti, facciate e coperture",
  "Scavi, ponteggi e demolizioni",
  "Foto per preventivi e report lavori",
  "Video per documentare prima e dopo",
...
const approfondimenti = [
  "Nel settore edile il drone può servire per capire meglio spazi, quote visive, accessi, avanzamento lavori e condizioni di parti alte o difficili.",
  "Il pilota può diventare un supporto per imprese e tecnici, consegnando materiale chiaro e ripetibile, senza sostituire le verifiche professionali richieste dalla legge.",
...
const faqs = [
  { q: "Le imprese edili cercano piloti drone?", a: "Sì, soprattutto per documentare cantieri, coperture, facciate, aree di lavoro e stati di avanzamento con immagini dall'alto." },
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Piloti drone per edilizia
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Piloti drone per lavori edili: richieste da imprese e privati
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta piloti drone, imprese edili, direttori lavori, geometri, architetti, amministratori e committenti che cercano documentazione dall'alto a trasformare una ricerca generica in una richiesta concreta. Questa pagina è pensata per chi cerca servizi drone per lavori edili, cantieri, ristrutturazioni, tetti, facciate, coperture, ponteggi, demolizioni, scavi e controlli visivi e vuole capire come pubblicare un annuncio, quali informazioni inserire e come ricevere candidature da piloti interessati. Il drone può essere utile quando servono immagini dall'alto, video ordinati, documentazione visiva, controllo di punti difficili da vedere da terra o materiale da condividere con tecnici, imprese, clienti, amministratori e responsabili aziendali.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per lavori edili su un edificio in ristrutturazione. Servono foto di tetto, facciata, ponteggi, cortile e stato avanzamento lavori.”
            </p>
          </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova o pubblica richieste per piloti drone per lavori edili
          </h2>
