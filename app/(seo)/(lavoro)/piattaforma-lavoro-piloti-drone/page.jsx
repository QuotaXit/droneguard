...
export const metadata = {
  title: "Piattaforma lavoro piloti drone | DroneGuard",
  description:
    "Piattaforma lavoro piloti drone: DroneGuard collega clienti e piloti per richieste di ispezioni, riprese, sopralluoghi, immobili, cantieri, fotovoltaico ed eventi."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Piattaforma per piloti drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Piattaforma lavoro piloti drone: incontra clienti e nuove richieste
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta clienti che cercano piloti e operatori drone che vogliono candidarsi a gestire richieste legate a piattaforma lavoro piloti drone.
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Il mercato dei servizi con drone è frammentato: chi cerca un pilota non sa dove pubblicare, mentre molti piloti non hanno un canale dedicato dove trovare richieste pertinenti. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ pubblicazione richieste</li>
              <li>✅ candidature dei piloti</li>
              <li>✅ confronto tra professionisti</li>
              <li>✅ servizi drone locali</li>
              <li>✅ lavori per aziende e privati</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per piattaforma lavoro piloti drone
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco una piattaforma dove pubblicare una richiesta per un lavoro con drone e ricevere candidature da piloti disponibili nella mia zona, con possibilità di spiegare bene il servizio richiesto.”
            </p>
          </div>
