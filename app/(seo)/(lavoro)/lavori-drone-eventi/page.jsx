...
export const metadata = {
  title: "Lavori drone eventi | DroneGuard",
  description:
    "Lavori drone eventi: trova piloti per riprese aeree di location, manifestazioni, matrimoni, eventi aziendali, inaugurazioni, feste e contenuti promozionali."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          ...
          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavori drone eventi: riprese aeree per location e manifestazioni
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta organizzatori, location, agenzie, aziende, videomaker e piloti drone a gestire richieste legate a lavori drone eventi.
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Negli eventi le riprese con drone richiedono pianificazione, valutazione degli spazi, sicurezza delle persone, autorizzazioni, meteo e coordinamento con organizzatori e videomaker. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ riprese di location eventi</li>
              <li>✅ video aziendali</li>
              <li>✅ matrimoni e cerimonie</li>
              <li>✅ manifestazioni autorizzate</li>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per lavori drone eventi
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco pilota drone per riprese aeree di una location eventi prima dell'arrivo degli ospiti. Servono immagini esterne, vista panoramica e video breve per promozione social.”
            </p>
          </div>
