...
export const metadata = {
  title: "Lavori drone agricoltura | DroneGuard",
  description:
    "Lavori drone agricoltura: trova piloti per vigneti, uliveti, campi, aziende agricole, monitoraggio visivo, foto dall'alto, mappature e documentazione dei terreni."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          ...
          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Lavori drone agricoltura: immagini dall'alto per terreni e coltivazioni
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            DroneGuard aiuta aziende agricole, proprietari di terreni, agronomi, consorzi e piloti drone a gestire richieste legate a lavori drone agricoltura.
          ...
          <div className="mt-8">
            <Link href="/register">
              <button className="rounded-xl bg-green-500 px-6 py-3 font-semibold text-black transition hover:bg-green-400">
                Cerca un pilota per agricoltura
              </button>
            </Link>
          </div>
        </div>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              In agricoltura può essere utile osservare dall'alto estensione, accessi, zone bagnate, filari, confini, pendenze, aree danneggiate e distribuzione generale delle colture. Una pagina SEO dedicata permette di spiegare in modo
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ foto di vigneti</li>
              <li>✅ controllo uliveti</li>
              <li>✅ documentazione campi</li>
              <li>✅ riprese di aziende agricole</li>
              <li>✅ panoramiche di terreni e accessi</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come usare DroneGuard per lavori drone agricoltura
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Azienda agricola cerca pilota drone per riprese di vigneti e terreni. Servono foto panoramiche, video dall'alto e immagini di alcuni accessi per documentazione interna.”
            </p>
          </div>
