...
export const metadata = {
  title: "Pilota Drone Varese | Trova Piloti Drone a Varese | DroneGuard",
  description:
    "Cerchi un pilota drone a Varese? Pubblica gratuitamente il tuo lavoro e ricevi candidature da piloti drone per riprese, ispezioni, eventi e servizi professionali."
}

export default function PilotaDroneVaresePage() {
  return (
    <main className="min-h-screen bg-[#0B0F2A] text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        <p className="text-gray-300 text-lg leading-8 mb-8">
          Cerchi un pilota drone a Varese per riprese video, fotografie aeree,
