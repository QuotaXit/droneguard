...
export const metadata = {
  title: "Pilota Drone Venezia | Trova Piloti Drone a Venezia | DroneGuard",
  description:
    "Cerchi un pilota drone a Venezia? Pubblica gratuitamente il tuo lavoro e ricevi candidature da piloti drone per riprese, ispezioni, eventi e servizi professionali."
}

export default function PilotaDroneVeneziaPage() {
  return (
