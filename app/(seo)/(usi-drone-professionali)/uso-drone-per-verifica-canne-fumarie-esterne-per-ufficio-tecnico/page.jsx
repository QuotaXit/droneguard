...
export const metadata = {
  title: "Uso drone per verifica canne fumarie esterne per ufficio tecnico | DroneGuard",
  description: "Uso drone per verifica canne fumarie esterne per ufficio tecnico: trova piloti drone su DroneGuard per foto, video, riprese aeree, sopralluoghi visivi e documentazione utile a amministratori, ditte specializzate, manutentori e proprietari."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          ...
          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Uso drone per verifica canne fumarie esterne per ufficio tecnico: foto, video e documentazione visiva dall alto
          </h1>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere un drone per verifica canne fumarie esterne per ufficio tecnico
            </h2>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="leading-8 text-gray-300">
              Per verifica canne fumarie esterne per ufficio tecnico, specifica se ti servono panoramiche, dettagli, video, immagini per preventivi, materiale per riunioni o documentazione da archiviare.
            </p>
          </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Esempio di richiesta: Cerco un pilota drone per verifica canne fumarie esterne per ufficio tecnico. Mi servono immagini chiare di comignoli, canne fumarie, staffaggi, terminali, fissaggi, attraversamenti e zone in quota. Il materiale verrà usato quando il materiale deve aiutare un ufficio tecnico o un consulente. Vorrei foto panoramiche, alcuni dettagli dei punti più importanti e, se possibile, un breve video dall alto per spiegare meglio il contesto. Posso indicare un referente sul posto e fornire eventuali foto da terra già disponibili.
          </p>
          <p className="mb-5 leading-8 text-gray-300">
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per verifica canne fumarie esterne per ufficio tecnico. Mi servono immagini di comignoli, canne fumarie, staffaggi, terminali, fissaggi, attraversamenti e zone in quota. Vorrei foto panoramiche, dettagli dei punti principali e un video breve dall alto. Il materiale servirà per quando il materiale deve aiutare un ufficio tecnico o un consulente.”
            </p>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">Posso usare DroneGuard per verifica canne fumarie esterne per ufficio tecnico?</h3>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">Trova un pilota drone per verifica canne fumarie esterne per ufficio tecnico</h2>
