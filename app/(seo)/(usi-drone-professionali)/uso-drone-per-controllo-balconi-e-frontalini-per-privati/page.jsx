...
export const metadata = {
  title: "Uso drone per controllo balconi e frontalini per privati | DroneGuard",
  description: "Uso drone per controllo balconi e frontalini per privati: trova piloti drone su DroneGuard per foto, video, riprese aeree, sopralluoghi visivi e documentazione utile a amministratori, proprietari, imprese edili e periti."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          ...
          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Uso drone per controllo balconi e frontalini per privati: foto, video e documentazione visiva dall alto
          </h1>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere un drone per controllo balconi e frontalini per privati
            </h2>
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per controllo balconi e frontalini per privati può essere utile documentare sottobalconi, frontalini, parapetti, pavimentazioni, macchie, crepe visibili e gocciolamenti. Questi elementi dovrebbero essere indicati nella richiesta, anche con parole semplici. Il pilota non ha bisogno di un testo tecnico perfetto, ma di sapere quali punti non devono mancare, da quale lato conviene riprendere, se servono dettagli ravvicinati o panoramiche e come verrà usato il materiale finale.
          </p>
          <p className="mb-5 leading-8 text-gray-300">
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="leading-8 text-gray-300">
              Per controllo balconi e frontalini per privati, specifica se ti servono panoramiche, dettagli, video, immagini per preventivi, materiale per riunioni o documentazione da archiviare.
            </p>
          </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Esempio di richiesta: Cerco un pilota drone per controllo balconi e frontalini per privati. Mi servono immagini chiare di sottobalconi, frontalini, parapetti, pavimentazioni, macchie, crepe visibili e gocciolamenti. Il materiale verrà usato quando un proprietario vuole capire meglio un punto difficile da osservare. Vorrei foto panoramiche, alcuni dettagli dei punti più importanti e, se possibile, un breve video dall alto per spiegare meglio il contesto. Posso indicare un referente sul posto e fornire eventuali foto da terra già disponibili.
          </p>
          <p className="mb-5 leading-8 text-gray-300">
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per controllo balconi e frontalini per privati. Mi servono immagini di sottobalconi, frontalini, parapetti, pavimentazioni, macchie, crepe visibili e gocciolamenti. Vorrei foto panoramiche, dettagli dei punti principali e un video breve dall alto. Il materiale servirà per quando un proprietario vuole capire meglio un punto difficile da osservare.”
            </p>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">Posso usare DroneGuard per controllo balconi e frontalini per privati?</h3>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">Trova un pilota drone per controllo balconi e frontalini per privati</h2>
