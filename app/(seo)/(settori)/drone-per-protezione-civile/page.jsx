...
export const metadata = {
  title: "Drone per protezione civile | DroneGuard",
  description:
    "Drone per protezione civile: trova piloti drone per foto, video, sopralluoghi aerei e documentazione visiva. Pubblica una richiesta su DroneGuard e scegli il candidato per aree allagate, frane, boschi, argini, strade interrotte, zone colpite da maltempo, campi base e percorsi di accesso."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Emergenze, territorio e supporto visivo con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per protezione civile: documentazione aerea per emergenze, territorio e criticità visibili
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Cerchi un pilota drone per aree allagate, frane, boschi, argini, strade interrotte, zone colpite da maltempo, campi base e percorsi di accesso? Con DroneGuard puoi pubblicare una richiesta chiara,
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere drone per protezione civile
            </h2>

            <p className="mb-5 leading-8 text-gray-300">
              Un servizio con drone è utile quando serve una visione dall'alto chiara e comprensibile di aree allagate, frane, boschi, argini, strade interrotte, zone colpite da maltempo, campi base e percorsi di accesso.
              ...
              meritano attenzione. Per drone per protezione civile, questo tipo di documentazione può essere utile prima di
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ aree colpite da maltempo, allagamenti o smottamenti</li>
              <li>✅ strade interrotte, accessi e zone di difficoltà</li>
              <li>✅ argini, corsi d'acqua e versanti visibili dall'alto</li>
              <li>✅ panoramiche utili a coordinare sopralluoghi</li>
              <li>✅ foto e video per relazioni interne e aggiornamenti</li>
              <li>✅ documentazione dopo interventi o esercitazioni</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel settore emergenze, territorio e supporto visivo, molte decisioni dipendono dalla capacità di leggere uno spazio nel suo
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per gruppi di protezione civile, comuni, associazioni, coordinamenti territoriali, tecnici e volontari autorizzati, avere immagini aggiornate può essere importante in molte fasi: preparare un
          ...
          <p className="leading-8 text-gray-300">
            ...
            che non cercano semplicemente &quot;drone&quot;, ma un servizio collegato al proprio problema. Chi cerca drone per protezione civile
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Prima di pubblicare un annuncio per drone per protezione civile, prepara una descrizione semplice ma completa.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              ...
              che tipo di materiale consegni e quali informazioni ti servono prima di confermare il lavoro. Per drone per protezione civile,
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Una richiesta efficace per drone per protezione civile dovrebbe rispondere a cinque domande: dove si trova il luogo,
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di aree allagate, frane, boschi, argini, strade interrotte, zone colpite da maltempo, campi base e percorsi di accesso, puoi indicare se il lavoro riguarda controllo visivo, promozione, manutenzione,
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per drone per protezione civile
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per supportare un sopralluogo di protezione civile dopo il maltempo: argini, strade, aree allagate, accessi e zone critiche visibili. Il materiale servirà solo come documentazione visiva.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per drone per protezione civile?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Quando il servizio riguarda aree allagate, frane, boschi, argini, strade interrotte, zone colpite da maltempo, campi base e percorsi di accesso, è importante evitare riprese inutili di persone, targhe,
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per drone per protezione civile?
              </h3>
              <p className="text-gray-300">
                Sì. Puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video, sopralluoghi visivi
                e documentazione collegata a aree allagate, frane, boschi, argini, strade interrotte, zone colpite da maltempo, campi base e percorsi di accesso.
              </p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova un pilota drone per drone per protezione civile
          </h2>
