...
export const metadata = {
  title: "Drone per depuratori | DroneGuard",
  description:
    "Drone per depuratori: trova piloti drone per foto, video, sopralluoghi aerei e documentazione visiva. Pubblica una richiesta su DroneGuard e scegli il candidato per depuratori, vasche, canali, piazzali, edifici tecnici, accessi, recinzioni, tubazioni esterne e aree di servizio."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Servizi idrici, ambiente e impianti tecnici con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per depuratori: documentazione aerea per vasche, impianti, accessi e aree tecniche esterne
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Cerchi un pilota drone per depuratori, vasche, canali, piazzali, edifici tecnici, accessi, recinzioni, tubazioni esterne e aree di servizio? Con DroneGuard puoi pubblicare una richiesta chiara,
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere drone per depuratori
            </h2>

            <p className="mb-5 leading-8 text-gray-300">
              Un servizio con drone è utile quando serve una visione dall'alto chiara e comprensibile di depuratori, vasche, canali, piazzali, edifici tecnici, accessi, recinzioni, tubazioni esterne e aree di servizio.
              ...
              meritano attenzione. Per drone per depuratori, questo tipo di documentazione può essere utile prima di
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ vasche, canali e manufatti esterni</li>
              <li>✅ edifici tecnici, piazzali e accessi</li>
              <li>✅ recinzioni, viabilità interna e aree di servizio</li>
              <li>✅ foto per manutenzione e report di gestione</li>
              <li>✅ documentazione dopo lavori, maltempo o criticità visibili</li>
              <li>✅ materiale per tecnici, direzione e fornitori</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel settore servizi idrici, ambiente e impianti tecnici, molte decisioni dipendono dalla capacità di leggere uno spazio nel suo
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per gestori depuratori, società idriche, comuni, tecnici, manutentori, consulenti ambientali e imprese specializzate, avere immagini aggiornate può essere importante in molte fasi: preparare un
          ...
          <p className="leading-8 text-gray-300">
            ...
            che non cercano semplicemente &quot;drone&quot;, ma un servizio collegato al proprio problema. Chi cerca drone per depuratori
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Prima di pubblicare un annuncio per drone per depuratori, prepara una descrizione semplice ma completa.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              ...
              che tipo di materiale consegni e quali informazioni ti servono prima di confermare il lavoro. Per drone per depuratori,
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Una richiesta efficace per drone per depuratori dovrebbe rispondere a cinque domande: dove si trova il luogo,
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di depuratori, vasche, canali, piazzali, edifici tecnici, accessi, recinzioni, tubazioni esterne e aree di servizio, puoi indicare se il lavoro riguarda controllo visivo, promozione, manutenzione,
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per drone per depuratori
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per documentare un depuratore: vasche, canali, edifici tecnici, accessi, recinzioni e piazzali. Il materiale servirà per report di gestione e manutenzione.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per drone per depuratori?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Quando il servizio riguarda depuratori, vasche, canali, piazzali, edifici tecnici, accessi, recinzioni, tubazioni esterne e aree di servizio, è importante evitare riprese inutili di persone, targhe,
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per drone per depuratori?
              </h3>
              <p className="text-gray-300">
                Sì. Puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video, sopralluoghi visivi
                e documentazione collegata a depuratori, vasche, canali, piazzali, edifici tecnici, accessi, recinzioni, tubazioni esterne e aree di servizio.
              </p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova un pilota drone per drone per depuratori
          </h2>
