...
export const metadata = {
  title: "Drone per condotte idriche | DroneGuard",
  description:
    "Drone per condotte idriche: trova piloti drone per foto, video, sopralluoghi aerei e documentazione visiva. Pubblica una richiesta su DroneGuard e scegli il candidato per tracciati esterni, pozzetti visibili, fasce di rispetto, attraversamenti, aree di cantiere, zone rurali e punti di accesso."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Reti idriche, infrastrutture e territorio con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per condotte idriche: documentazione aerea per tracciati, aree esterne e criticità visibili
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Cerchi un pilota drone per tracciati esterni, pozzetti visibili, fasce di rispetto, attraversamenti, aree di cantiere, zone rurali e punti di accesso? Con DroneGuard puoi pubblicare una richiesta chiara,
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere drone per condotte idriche
            </h2>

            <p className="mb-5 leading-8 text-gray-300">
              Un servizio con drone è utile quando serve una visione dall'alto chiara e comprensibile di tracciati esterni, pozzetti visibili, fasce di rispetto, attraversamenti, aree di cantiere, zone rurali e punti di accesso.
              ...
              meritano attenzione. Per drone per condotte idriche, questo tipo di documentazione può essere utile prima di
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ tracciati esterni e fasce di terreno da documentare</li>
              <li>✅ pozzetti, accessi e manufatti visibili dall'alto</li>
              <li>✅ attraversamenti stradali, agricoli o fluviali</li>
              <li>✅ aree di cantiere e zone di ripristino</li>
              <li>✅ foto prima e dopo manutenzioni o scavi</li>
              <li>✅ materiale per tecnici, gestori e imprese incaricate</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel settore reti idriche, infrastrutture e territorio, molte decisioni dipendono dalla capacità di leggere uno spazio nel suo
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per gestori reti, consorzi, tecnici, imprese di manutenzione, comuni e società di servizi idrici, avere immagini aggiornate può essere importante in molte fasi: preparare un
          ...
          <p className="leading-8 text-gray-300">
            ...
            che non cercano semplicemente &quot;drone&quot;, ma un servizio collegato al proprio problema. Chi cerca drone per condotte idriche
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Prima di pubblicare un annuncio per drone per condotte idriche, prepara una descrizione semplice ma completa.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              ...
              che tipo di materiale consegni e quali informazioni ti servono prima di confermare il lavoro. Per drone per condotte idriche,
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Una richiesta efficace per drone per condotte idriche dovrebbe rispondere a cinque domande: dove si trova il luogo,
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di tracciati esterni, pozzetti visibili, fasce di rispetto, attraversamenti, aree di cantiere, zone rurali e punti di accesso, puoi indicare se il lavoro riguarda controllo visivo, promozione, manutenzione,
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per drone per condotte idriche
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per documentare un tratto di condotta idrica esterna: tracciato, pozzetti visibili, attraversamenti, aree di accesso e zone di ripristino. Il materiale servirà per valutazioni tecniche.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per drone per condotte idriche?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Quando il servizio riguarda tracciati esterni, pozzetti visibili, fasce di rispetto, attraversamenti, aree di cantiere, zone rurali e punti di accesso, è importante evitare riprese inutili di persone, targhe,
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per drone per condotte idriche?
              </h3>
              <p className="text-gray-300">
                Sì. Puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video, sopralluoghi visivi
                e documentazione collegata a tracciati esterni, pozzetti visibili, fasce di rispetto, attraversamenti, aree di cantiere, zone rurali e punti di accesso.
              </p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova un pilota drone per drone per condotte idriche
          </h2>
