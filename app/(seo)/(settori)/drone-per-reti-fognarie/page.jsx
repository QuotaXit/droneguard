...
export const metadata = {
  title: "Drone per reti fognarie | DroneGuard",
  description:
    "Drone per reti fognarie: trova piloti drone per foto, video, sopralluoghi aerei e documentazione visiva. Pubblica una richiesta su DroneGuard e scegli il candidato per aree esterne di reti fognarie, pozzetti, tracciati superficiali, cantieri, strade, ripristini, impianti di sollevamento e accessi te"
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Sottoservizi, cantieri e manutenzione urbana con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per reti fognarie: foto e video dall'alto per aree esterne, pozzetti, cantieri e ripristini
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Cerchi un pilota drone per aree esterne di reti fognarie, pozzetti, tracciati superficiali, cantieri, strade, ripristini, impianti di sollevamento e accessi tecnici? Con DroneGuard puoi pubblicare una richiesta chiara,
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere drone per reti fognarie
            </h2>

            <p className="mb-5 leading-8 text-gray-300">
              Un servizio con drone è utile quando serve una visione dall'alto chiara e comprensibile di aree esterne di reti fognarie, pozzetti, tracciati superficiali, cantieri, strade, ripristini, impianti di sollevamento e accessi tecnici.
              ...
              meritano attenzione. Per drone per reti fognarie, questo tipo di documentazione può essere utile prima di
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ pozzetti e manufatti visibili in superficie</li>
              <li>✅ tracciati, strade e aree di cantiere collegate</li>
              <li>✅ ripristini dopo scavi e lavori di manutenzione</li>
              <li>✅ impianti di sollevamento e aree tecniche esterne</li>
              <li>✅ foto per tecnici, direzione lavori e imprese</li>
              <li>✅ documentazione prima, durante e dopo interventi</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel settore sottoservizi, cantieri e manutenzione urbana, molte decisioni dipendono dalla capacità di leggere uno spazio nel suo
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per comuni, gestori reti, imprese stradali, tecnici, società di manutenzione e consorzi, avere immagini aggiornate può essere importante in molte fasi: preparare un
          ...
          <p className="leading-8 text-gray-300">
            ...
            che non cercano semplicemente &quot;drone&quot;, ma un servizio collegato al proprio problema. Chi cerca drone per reti fognarie
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Prima di pubblicare un annuncio per drone per reti fognarie, prepara una descrizione semplice ma completa.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              ...
              che tipo di materiale consegni e quali informazioni ti servono prima di confermare il lavoro. Per drone per reti fognarie,
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Una richiesta efficace per drone per reti fognarie dovrebbe rispondere a cinque domande: dove si trova il luogo,
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di aree esterne di reti fognarie, pozzetti, tracciati superficiali, cantieri, strade, ripristini, impianti di sollevamento e accessi tecnici, puoi indicare se il lavoro riguarda controllo visivo, promozione, manutenzione,
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per drone per reti fognarie
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per documentare un intervento su rete fognaria: area di cantiere, pozzetti, tracciato superficiale, ripristini stradali e accessi tecnici. Servono foto ordinate e video panoramico.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per drone per reti fognarie?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Quando il servizio riguarda aree esterne di reti fognarie, pozzetti, tracciati superficiali, cantieri, strade, ripristini, impianti di sollevamento e accessi tecnici, è importante evitare riprese inutili di persone, targhe,
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per drone per reti fognarie?
              </h3>
              <p className="text-gray-300">
                Sì. Puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video, sopralluoghi visivi
                e documentazione collegata a aree esterne di reti fognarie, pozzetti, tracciati superficiali, cantieri, strade, ripristini, impianti di sollevamento e accessi tecnici.
              </p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova un pilota drone per drone per reti fognarie
          </h2>
