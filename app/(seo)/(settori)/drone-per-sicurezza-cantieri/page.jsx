...
export const metadata = {
  title: "Drone per sicurezza cantieri | DroneGuard",
  description:
    "Drone per sicurezza cantieri: trova piloti drone per foto, video, sopralluoghi aerei e documentazione visiva. Pubblica una richiesta su DroneGuard e scegli il candidato per cantieri edili, aree operative, accessi, ponteggi, coperture provvisorie, depositi materiali, recinzioni e zone di passaggio."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Edilizia, cantieri e sicurezza con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per sicurezza cantieri: sopralluoghi aerei, foto e video per controlli visivi
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Cerchi un pilota drone per cantieri edili, aree operative, accessi, ponteggi, coperture provvisorie, depositi materiali, recinzioni e zone di passaggio? Con DroneGuard puoi pubblicare una richiesta chiara,
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere drone per sicurezza cantieri
            </h2>

            <p className="mb-5 leading-8 text-gray-300">
              Un servizio con drone è utile quando serve una visione dall'alto chiara e comprensibile di cantieri edili, aree operative, accessi, ponteggi, coperture provvisorie, depositi materiali, recinzioni e zone di passaggio.
              ...
              meritano attenzione. Per drone per sicurezza cantieri, questo tipo di documentazione può essere utile prima di
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ accessi di cantiere e percorsi interni</li>
              <li>✅ ponteggi, parapetti e aree in quota visibili dall'esterno</li>
              <li>✅ depositi materiali, mezzi e zone di manovra</li>
              <li>✅ recinzioni, cancelli, protezioni e confini operativi</li>
              <li>✅ stato avanzamento lavori e criticità visibili</li>
              <li>✅ foto e video per riunioni tecniche, report interni e preventivi</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel settore edilizia, cantieri e sicurezza, molte decisioni dipendono dalla capacità di leggere uno spazio nel suo
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per imprese edili, coordinatori della sicurezza, direttori lavori, responsabili tecnici, committenti e società di manutenzione, avere immagini aggiornate può essere importante in molte fasi: preparare un
          ...
          <p className="leading-8 text-gray-300">
            ...
            che non cercano semplicemente &quot;drone&quot;, ma un servizio collegato al proprio problema. Chi cerca drone per sicurezza cantieri
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Prima di pubblicare un annuncio per drone per sicurezza cantieri, prepara una descrizione semplice ma completa.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              ...
              che tipo di materiale consegni e quali informazioni ti servono prima di confermare il lavoro. Per drone per sicurezza cantieri,
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Una richiesta efficace per drone per sicurezza cantieri dovrebbe rispondere a cinque domande: dove si trova il luogo,
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di cantieri edili, aree operative, accessi, ponteggi, coperture provvisorie, depositi materiali, recinzioni e zone di passaggio, puoi indicare se il lavoro riguarda controllo visivo, promozione, manutenzione,
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per drone per sicurezza cantieri
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per documentare la sicurezza visiva di un cantiere: accessi, ponteggi, recinzioni, depositi materiali, zone di manovra e stato generale dell'area. Il materiale servirà per confrontarmi con direzione lavori, impresa e coordinatore sicurezza.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per drone per sicurezza cantieri?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Quando il servizio riguarda cantieri edili, aree operative, accessi, ponteggi, coperture provvisorie, depositi materiali, recinzioni e zone di passaggio, è importante evitare riprese inutili di persone, targhe,
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per drone per sicurezza cantieri?
              </h3>
              <p className="text-gray-300">
                Sì. Puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video, sopralluoghi visivi
                e documentazione collegata a cantieri edili, aree operative, accessi, ponteggi, coperture provvisorie, depositi materiali, recinzioni e zone di passaggio.
              </p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova un pilota drone per drone per sicurezza cantieri
          </h2>
