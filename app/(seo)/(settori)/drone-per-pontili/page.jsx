...
export const metadata = {
  title: "Drone per pontili | DroneGuard",
  description:
    "Drone per pontili: trova piloti drone per foto, video, sopralluoghi aerei e documentazione visiva. Pubblica una richiesta su DroneGuard e scegli il candidato per pontili, passerelle, darsene, banchine leggere, accessi al mare, stabilimenti balneari, aree turistiche e strutture su laghi."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Nautica, turismo e strutture costiere con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per pontili: foto e video per strutture sul mare, laghi, darsene e aree turistiche
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Cerchi un pilota drone per pontili, passerelle, darsene, banchine leggere, accessi al mare, stabilimenti balneari, aree turistiche e strutture su laghi? Con DroneGuard puoi pubblicare una richiesta chiara,
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere drone per pontili
            </h2>

            <p className="mb-5 leading-8 text-gray-300">
              Un servizio con drone è utile quando serve una visione dall'alto chiara e comprensibile di pontili, passerelle, darsene, banchine leggere, accessi al mare, stabilimenti balneari, aree turistiche e strutture su laghi.
              ...
              meritano attenzione. Per drone per pontili, questo tipo di documentazione può essere utile prima di
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ panoramiche di pontili, passerelle e accessi</li>
              <li>✅ stato visibile di superfici, parapetti e connessioni</li>
              <li>✅ banchine, darsene e aree di ormeggio</li>
              <li>✅ foto promozionali per turismo e strutture ricettive</li>
              <li>✅ documentazione dopo mareggiate o maltempo</li>
              <li>✅ video per presentazioni, siti web e social</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel settore nautica, turismo e strutture costiere, molte decisioni dipendono dalla capacità di leggere uno spazio nel suo
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per stabilimenti, porti turistici, darsene, comuni, gestori di pontili, strutture ricettive e tecnici manutentori, avere immagini aggiornate può essere importante in molte fasi: preparare un
          ...
          <p className="leading-8 text-gray-300">
            ...
            che non cercano semplicemente &quot;drone&quot;, ma un servizio collegato al proprio problema. Chi cerca drone per pontili
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Prima di pubblicare un annuncio per drone per pontili, prepara una descrizione semplice ma completa.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              ...
              che tipo di materiale consegni e quali informazioni ti servono prima di confermare il lavoro. Per drone per pontili,
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Una richiesta efficace per drone per pontili dovrebbe rispondere a cinque domande: dove si trova il luogo,
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di pontili, passerelle, darsene, banchine leggere, accessi al mare, stabilimenti balneari, aree turistiche e strutture su laghi, puoi indicare se il lavoro riguarda controllo visivo, promozione, manutenzione,
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per drone per pontili
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per riprendere un pontile turistico: accessi, passerelle, banchina, area mare e struttura circostante. Servono foto e video per promozione e documentazione dello stato esterno.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per drone per pontili?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Quando il servizio riguarda pontili, passerelle, darsene, banchine leggere, accessi al mare, stabilimenti balneari, aree turistiche e strutture su laghi, è importante evitare riprese inutili di persone, targhe,
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per drone per pontili?
              </h3>
              <p className="text-gray-300">
                Sì. Puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video, sopralluoghi visivi
                e documentazione collegata a pontili, passerelle, darsene, banchine leggere, accessi al mare, stabilimenti balneari, aree turistiche e strutture su laghi.
              </p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova un pilota drone per drone per pontili
          </h2>
