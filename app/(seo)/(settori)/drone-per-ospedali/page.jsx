...
export const metadata = {
  title: "Drone per ospedali | DroneGuard",
  description:
    "Drone per ospedali: trova piloti drone per foto, video, sopralluoghi aerei e documentazione visiva. Pubblica una richiesta su DroneGuard e scegli il candidato per ospedali, poliambulatori, coperture, impianti esterni, parcheggi, ingressi, aree di servizio e percorsi di emergenza esterni."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Sanità, grandi edifici e facility management con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per ospedali: documentazione visiva per grandi edifici sanitari, coperture e aree esterne
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Cerchi un pilota drone per ospedali, poliambulatori, coperture, impianti esterni, parcheggi, ingressi, aree di servizio e percorsi di emergenza esterni? Con DroneGuard puoi pubblicare una richiesta chiara,
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere drone per ospedali
            </h2>

            <p className="mb-5 leading-8 text-gray-300">
              Un servizio con drone è utile quando serve una visione dall'alto chiara e comprensibile di ospedali, poliambulatori, coperture, impianti esterni, parcheggi, ingressi, aree di servizio e percorsi di emergenza esterni.
              ...
              meritano attenzione. Per drone per ospedali, questo tipo di documentazione può essere utile prima di
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ coperture, terrazzi tecnici e impianti esterni visibili</li>
              <li>✅ parcheggi, ingressi, rampe e aree di servizio</li>
              <li>✅ facciate, lucernari, gronde e parti alte</li>
              <li>✅ documentazione per manutenzione programmata</li>
              <li>✅ foto prima e dopo lavori o danni da maltempo</li>
              <li>✅ materiale ordinato per uffici tecnici e fornitori</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel settore sanità, grandi edifici e facility management, molte decisioni dipendono dalla capacità di leggere uno spazio nel suo
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per strutture sanitarie, ospedali, uffici tecnici, facility manager, imprese di manutenzione e proprietà immobiliari, avere immagini aggiornate può essere importante in molte fasi: preparare un
          ...
          <p className="leading-8 text-gray-300">
            ...
            che non cercano semplicemente &quot;drone&quot;, ma un servizio collegato al proprio problema. Chi cerca drone per ospedali
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Prima di pubblicare un annuncio per drone per ospedali, prepara una descrizione semplice ma completa.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              ...
              che tipo di materiale consegni e quali informazioni ti servono prima di confermare il lavoro. Per drone per ospedali,
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Una richiesta efficace per drone per ospedali dovrebbe rispondere a cinque domande: dove si trova il luogo,
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di ospedali, poliambulatori, coperture, impianti esterni, parcheggi, ingressi, aree di servizio e percorsi di emergenza esterni, puoi indicare se il lavoro riguarda controllo visivo, promozione, manutenzione,
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per drone per ospedali
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per documentare dall'alto un edificio ospedaliero: coperture, impianti esterni, parcheggi, ingressi e aree tecniche. Il materiale servirà per manutenzione e valutazioni interne.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per drone per ospedali?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Quando il servizio riguarda ospedali, poliambulatori, coperture, impianti esterni, parcheggi, ingressi, aree di servizio e percorsi di emergenza esterni, è importante evitare riprese inutili di persone, targhe,
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per drone per ospedali?
              </h3>
              <p className="text-gray-300">
                Sì. Puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video, sopralluoghi visivi
                e documentazione collegata a ospedali, poliambulatori, coperture, impianti esterni, parcheggi, ingressi, aree di servizio e percorsi di emergenza esterni.
              </p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova un pilota drone per drone per ospedali
          </h2>
