...
export const metadata = {
  title: "Drone per stadi | DroneGuard",
  description:
    "Drone per stadi: trova piloti drone per foto, video, sopralluoghi aerei e documentazione visiva. Pubblica una richiesta su DroneGuard e scegli il candidato per stadi, tribune, coperture, torri faro, parcheggi, ingressi, aree di afflusso e spazi esterni di pertinenza."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Sport, grandi strutture e comunicazione con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per stadi: panoramiche, controlli visivi e video per strutture sportive complesse
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Cerchi un pilota drone per stadi, tribune, coperture, torri faro, parcheggi, ingressi, aree di afflusso e spazi esterni di pertinenza? Con DroneGuard puoi pubblicare una richiesta chiara,
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere drone per stadi
            </h2>

            <p className="mb-5 leading-8 text-gray-300">
              Un servizio con drone è utile quando serve una visione dall'alto chiara e comprensibile di stadi, tribune, coperture, torri faro, parcheggi, ingressi, aree di afflusso e spazi esterni di pertinenza.
              ...
              meritano attenzione. Per drone per stadi, questo tipo di documentazione può essere utile prima di
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ tribune, coperture e strutture alte visibili dall'esterno</li>
              <li>✅ torri faro, recinzioni e accessi principali</li>
              <li>✅ parcheggi, aree di afflusso e percorsi esterni</li>
              <li>✅ foto e video istituzionali per presentazioni</li>
              <li>✅ documentazione prima e dopo interventi o eventi</li>
              <li>✅ materiale utile a tecnici, gestori e direzione</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel settore sport, grandi strutture e comunicazione, molte decisioni dipendono dalla capacità di leggere uno spazio nel suo
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per gestori di stadi, società sportive, comuni, tecnici, agenzie di comunicazione e imprese di manutenzione, avere immagini aggiornate può essere importante in molte fasi: preparare un
          ...
          <p className="leading-8 text-gray-300">
            ...
            che non cercano semplicemente &quot;drone&quot;, ma un servizio collegato al proprio problema. Chi cerca drone per stadi
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Prima di pubblicare un annuncio per drone per stadi, prepara una descrizione semplice ma completa.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              ...
              che tipo di materiale consegni e quali informazioni ti servono prima di confermare il lavoro. Per drone per stadi,
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Una richiesta efficace per drone per stadi dovrebbe rispondere a cinque domande: dove si trova il luogo,
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di stadi, tribune, coperture, torri faro, parcheggi, ingressi, aree di afflusso e spazi esterni di pertinenza, puoi indicare se il lavoro riguarda controllo visivo, promozione, manutenzione,
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per drone per stadi
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per documentare uno stadio dall'esterno: tribune, coperture, torri faro, ingressi, parcheggi e aree di afflusso. Il materiale servirà per presentazione e valutazioni tecniche.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per drone per stadi?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Quando il servizio riguarda stadi, tribune, coperture, torri faro, parcheggi, ingressi, aree di afflusso e spazi esterni di pertinenza, è importante evitare riprese inutili di persone, targhe,
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per drone per stadi?
              </h3>
              <p className="text-gray-300">
                Sì. Puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video, sopralluoghi visivi
                e documentazione collegata a stadi, tribune, coperture, torri faro, parcheggi, ingressi, aree di afflusso e spazi esterni di pertinenza.
              </p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova un pilota drone per drone per stadi
          </h2>
