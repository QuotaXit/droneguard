...
export const metadata = {
  title: "Drone per vivai | DroneGuard",
  description:
    "Drone per vivai: trova piloti drone per foto, video, sopralluoghi aerei e documentazione visiva. Pubblica una richiesta su DroneGuard e scegli il candidato per vivai, piante in vaso, serre, piazzali, lotti, filari, zone di irrigazione, parcheggi, ingressi e aree espositive."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Vivaismo, garden center e attività agricole con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per vivai: foto e video per piante, serre, lotti produttivi, piazzali e garden center
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Cerchi un pilota drone per vivai, piante in vaso, serre, piazzali, lotti, filari, zone di irrigazione, parcheggi, ingressi e aree espositive? Con DroneGuard puoi pubblicare una richiesta chiara,
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere drone per vivai
            </h2>

            <p className="mb-5 leading-8 text-gray-300">
              Un servizio con drone è utile quando serve una visione dall'alto chiara e comprensibile di vivai, piante in vaso, serre, piazzali, lotti, filari, zone di irrigazione, parcheggi, ingressi e aree espositive.
              ...
              meritano attenzione. Per drone per vivai, questo tipo di documentazione può essere utile prima di
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ panoramiche di lotti produttivi e aree espositive</li>
              <li>✅ serre, filari, piazzali e zone irrigazione</li>
              <li>✅ ingressi, parcheggi e percorsi clienti</li>
              <li>✅ foto per cataloghi, sito e social</li>
              <li>✅ video per promuovere il garden center</li>
              <li>✅ documentazione per ampliamenti o riorganizzazione spazi</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel settore vivaismo, garden center e attività agricole, molte decisioni dipendono dalla capacità di leggere uno spazio nel suo
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per vivai, garden center, aziende agricole, agronomi, rivenditori, progettisti del verde e agenzie marketing, avere immagini aggiornate può essere importante in molte fasi: preparare un
          ...
          <p className="leading-8 text-gray-300">
            ...
            che non cercano semplicemente &quot;drone&quot;, ma un servizio collegato al proprio problema. Chi cerca drone per vivai
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Prima di pubblicare un annuncio per drone per vivai, prepara una descrizione semplice ma completa.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              ...
              che tipo di materiale consegni e quali informazioni ti servono prima di confermare il lavoro. Per drone per vivai,
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Una richiesta efficace per drone per vivai dovrebbe rispondere a cinque domande: dove si trova il luogo,
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di vivai, piante in vaso, serre, piazzali, lotti, filari, zone di irrigazione, parcheggi, ingressi e aree espositive, puoi indicare se il lavoro riguarda controllo visivo, promozione, manutenzione,
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per drone per vivai
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per foto e video di un vivaio: serre, lotti produttivi, piante, piazzali, ingresso, parcheggio e aree espositive. Il materiale servirà per sito e promozione.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per drone per vivai?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Quando il servizio riguarda vivai, piante in vaso, serre, piazzali, lotti, filari, zone di irrigazione, parcheggi, ingressi e aree espositive, è importante evitare riprese inutili di persone, targhe,
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per drone per vivai?
              </h3>
              <p className="text-gray-300">
                Sì. Puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video, sopralluoghi visivi
                e documentazione collegata a vivai, piante in vaso, serre, piazzali, lotti, filari, zone di irrigazione, parcheggi, ingressi e aree espositive.
              </p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova un pilota drone per drone per vivai
          </h2>
