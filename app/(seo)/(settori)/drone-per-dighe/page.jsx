...
export const metadata = {
  title: "Drone per dighe | DroneGuard",
  description:
    "Drone per dighe: trova piloti drone per foto, video, sopralluoghi aerei e documentazione visiva. Pubblica una richiesta su DroneGuard e scegli il candidato per dighe, invasi, coronamenti, sponde, versanti, strade di accesso, aree tecniche, manufatti e zone di sicurezza esterne."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Infrastrutture idrauliche e territorio con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per dighe: documentazione aerea per invasi, coronamenti, versanti e aree tecniche
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Cerchi un pilota drone per dighe, invasi, coronamenti, sponde, versanti, strade di accesso, aree tecniche, manufatti e zone di sicurezza esterne? Con DroneGuard puoi pubblicare una richiesta chiara,
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere drone per dighe
            </h2>

            <p className="mb-5 leading-8 text-gray-300">
              Un servizio con drone è utile quando serve una visione dall'alto chiara e comprensibile di dighe, invasi, coronamenti, sponde, versanti, strade di accesso, aree tecniche, manufatti e zone di sicurezza esterne.
              ...
              meritano attenzione. Per drone per dighe, questo tipo di documentazione può essere utile prima di
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ panoramiche di invaso, sponde e versanti</li>
              <li>✅ coronamento, strade di accesso e manufatti visibili</li>
              <li>✅ aree tecniche, recinzioni e zone di servizio</li>
              <li>✅ documentazione dopo piogge intense o lavori</li>
              <li>✅ foto per tecnici, gestori e relazioni interne</li>
              <li>✅ video panoramici per presentazioni e monitoraggi visivi</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel settore infrastrutture idrauliche e territorio, molte decisioni dipendono dalla capacità di leggere uno spazio nel suo
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per gestori infrastrutture, enti territoriali, tecnici, società di manutenzione, consorzi e uffici tecnici pubblici, avere immagini aggiornate può essere importante in molte fasi: preparare un
          ...
          <p className="leading-8 text-gray-300">
            ...
            che non cercano semplicemente &quot;drone&quot;, ma un servizio collegato al proprio problema. Chi cerca drone per dighe
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Prima di pubblicare un annuncio per drone per dighe, prepara una descrizione semplice ma completa.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              ...
              che tipo di materiale consegni e quali informazioni ti servono prima di confermare il lavoro. Per drone per dighe,
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Una richiesta efficace per drone per dighe dovrebbe rispondere a cinque domande: dove si trova il luogo,
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di dighe, invasi, coronamenti, sponde, versanti, strade di accesso, aree tecniche, manufatti e zone di sicurezza esterne, puoi indicare se il lavoro riguarda controllo visivo, promozione, manutenzione,
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per drone per dighe
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per documentare una diga e le aree esterne: invaso, sponde, coronamento, accessi, versanti e manufatti visibili. Il materiale servirà per analisi visiva e archivio tecnico.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per drone per dighe?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Quando il servizio riguarda dighe, invasi, coronamenti, sponde, versanti, strade di accesso, aree tecniche, manufatti e zone di sicurezza esterne, è importante evitare riprese inutili di persone, targhe,
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per drone per dighe?
              </h3>
              <p className="text-gray-300">
                Sì. Puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video, sopralluoghi visivi
                e documentazione collegata a dighe, invasi, coronamenti, sponde, versanti, strade di accesso, aree tecniche, manufatti e zone di sicurezza esterne.
              </p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova un pilota drone per drone per dighe
          </h2>
