...
export const metadata = {
  title: "Drone per controllo strade | DroneGuard",
  description:
    "Drone per controllo strade: trova piloti drone per foto, video, sopralluoghi aerei e documentazione visiva. Pubblica una richiesta su DroneGuard e scegli il candidato per strade comunali, strade private, accessi carrabili, banchine, scarpate, attraversamenti, parcheggi e aree esterne collegate alla "
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Strade, territorio e manutenzione urbana con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per controllo strade: documentazione aerea per tratti viari, danni e criticità visibili
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Cerchi un pilota drone per strade comunali, strade private, accessi carrabili, banchine, scarpate, attraversamenti, parcheggi e aree esterne collegate alla viabilità? Con DroneGuard puoi pubblicare una richiesta chiara,
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere drone per controllo strade
            </h2>

            <p className="mb-5 leading-8 text-gray-300">
              Un servizio con drone è utile quando serve una visione dall'alto chiara e comprensibile di strade comunali, strade private, accessi carrabili, banchine, scarpate, attraversamenti, parcheggi e aree esterne collegate alla viabilità.
              ...
              meritano attenzione. Per drone per controllo strade, questo tipo di documentazione può essere utile prima di
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ tratti stradali con buche, cedimenti o deformazioni visibili</li>
              <li>✅ banchine, cunette e scarpate laterali</li>
              <li>✅ accessi, incroci e aree di manovra</li>
              <li>✅ danni dopo maltempo, allagamenti o smottamenti</li>
              <li>✅ documentazione prima e dopo lavori di manutenzione</li>
              <li>✅ foto e video per segnalazioni, preventivi e confronti tecnici</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel settore strade, territorio e manutenzione urbana, molte decisioni dipendono dalla capacità di leggere uno spazio nel suo
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per comuni, consorzi stradali, tecnici, imprese di manutenzione, amministratori di aree private e responsabili viabilità, avere immagini aggiornate può essere importante in molte fasi: preparare un
          ...
          <p className="leading-8 text-gray-300">
            ...
            che non cercano semplicemente &quot;drone&quot;, ma un servizio collegato al proprio problema. Chi cerca drone per controllo strade
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Prima di pubblicare un annuncio per drone per controllo strade, prepara una descrizione semplice ma completa.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              ...
              che tipo di materiale consegni e quali informazioni ti servono prima di confermare il lavoro. Per drone per controllo strade,
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Una richiesta efficace per drone per controllo strade dovrebbe rispondere a cinque domande: dove si trova il luogo,
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di strade comunali, strade private, accessi carrabili, banchine, scarpate, attraversamenti, parcheggi e aree esterne collegate alla viabilità, puoi indicare se il lavoro riguarda controllo visivo, promozione, manutenzione,
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per drone per controllo strade
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per riprendere un tratto stradale con criticità visibili, banchine rovinate e possibili danni dopo il maltempo. Vorrei foto panoramiche, video dall'alto e dettagli ordinati per valutare un intervento di manutenzione.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per drone per controllo strade?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Quando il servizio riguarda strade comunali, strade private, accessi carrabili, banchine, scarpate, attraversamenti, parcheggi e aree esterne collegate alla viabilità, è importante evitare riprese inutili di persone, targhe,
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per drone per controllo strade?
              </h3>
              <p className="text-gray-300">
                Sì. Puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video, sopralluoghi visivi
                e documentazione collegata a strade comunali, strade private, accessi carrabili, banchine, scarpate, attraversamenti, parcheggi e aree esterne collegate alla viabilità.
              </p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova un pilota drone per drone per controllo strade
          </h2>
