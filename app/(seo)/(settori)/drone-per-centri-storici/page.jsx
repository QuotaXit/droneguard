...
export const metadata = {
  title: "Drone per centri storici | DroneGuard",
  description:
    "Drone per centri storici: trova piloti drone per foto, video, sopralluoghi aerei e documentazione visiva. Pubblica una richiesta su DroneGuard e scegli il candidato per centri storici, piazze, tetti, campanili, mura, vie principali, aree pedonali, monumenti esterni e percorsi turistici."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-green-400">
            Comuni, turismo e patrimonio urbano con drone
          </p>

          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per centri storici: riprese aeree per promozione, documentazione urbana e patrimonio esterno
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Cerchi un pilota drone per centri storici, piazze, tetti, campanili, mura, vie principali, aree pedonali, monumenti esterni e percorsi turistici? Con DroneGuard puoi pubblicare una richiesta chiara,
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere drone per centri storici
            </h2>

            <p className="mb-5 leading-8 text-gray-300">
              Un servizio con drone è utile quando serve una visione dall'alto chiara e comprensibile di centri storici, piazze, tetti, campanili, mura, vie principali, aree pedonali, monumenti esterni e percorsi turistici.
              ...
              meritano attenzione. Per drone per centri storici, questo tipo di documentazione può essere utile prima di
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ panoramiche di piazze, vie e monumenti esterni</li>
              <li>✅ tetti, coperture e scorci urbani visibili dall'alto</li>
              <li>✅ percorsi turistici e accessi principali</li>
              <li>✅ video promozionali per turismo e comunicazione</li>
              <li>✅ documentazione prima e dopo eventi cittadini</li>
              <li>✅ materiale per siti istituzionali, social e brochure</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel settore comuni, turismo e patrimonio urbano, molte decisioni dipendono dalla capacità di leggere uno spazio nel suo
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per comuni, enti turistici, associazioni culturali, uffici comunicazione, tecnici e organizzatori di eventi cittadini, avere immagini aggiornate può essere importante in molte fasi: preparare un
          ...
          <p className="leading-8 text-gray-300">
            ...
            che non cercano semplicemente &quot;drone&quot;, ma un servizio collegato al proprio problema. Chi cerca drone per centri storici
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Prima di pubblicare un annuncio per drone per centri storici, prepara una descrizione semplice ma completa.
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mb-5 leading-8 text-gray-300">
              ...
              che tipo di materiale consegni e quali informazioni ti servono prima di confermare il lavoro. Per drone per centri storici,
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Una richiesta efficace per drone per centri storici dovrebbe rispondere a cinque domande: dove si trova il luogo,
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di centri storici, piazze, tetti, campanili, mura, vie principali, aree pedonali, monumenti esterni e percorsi turistici, puoi indicare se il lavoro riguarda controllo visivo, promozione, manutenzione,
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per drone per centri storici
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per realizzare immagini aeree di un centro storico: piazza principale, vie pedonali, monumenti esterni, tetti e punti panoramici. Il materiale servirà per comunicazione turistica.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per drone per centri storici?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Quando il servizio riguarda centri storici, piazze, tetti, campanili, mura, vie principali, aree pedonali, monumenti esterni e percorsi turistici, è importante evitare riprese inutili di persone, targhe,
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per drone per centri storici?
              </h3>
              <p className="text-gray-300">
                Sì. Puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video, sopralluoghi visivi
                e documentazione collegata a centri storici, piazze, tetti, campanili, mura, vie principali, aree pedonali, monumenti esterni e percorsi turistici.
              </p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">
            Trova un pilota drone per drone per centri storici
          </h2>
