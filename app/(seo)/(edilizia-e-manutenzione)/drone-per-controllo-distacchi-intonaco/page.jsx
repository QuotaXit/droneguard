...
export const metadata = {
  title: "Drone per controllo distacchi intonaco | DroneGuard",
  description:
    "Drone per controllo distacchi intonaco: trova piloti drone per foto, video e documentazione visiva di controllo distacchi intonaco, edilizia, manutenzione, coperture, facciate, condomini e interventi tecnici."
}
    ...
    <main className="min-h-screen bg-[#0B0F2A] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="mb-14 grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="leading-7 text-gray-300">
              Richiedi immagini di intonaco, rasature, frontalini, sottobalconi, macchie, ferri scoperti, rigonfiamenti e parti deteriorate. Il drone permette di vedere la scena da una prospettiva più ampia e di raccogliere materiale utile per capire quali punti meritano maggiore attenzione.
            </p>
          </div>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere controllo distacchi intonaco con drone
            </h2>
            ...
            <p className="mb-5 leading-8 text-gray-300">
              Per controllo distacchi intonaco, il drone può essere richiesto prima di una manutenzione programmata, dopo un evento di maltempo, durante una ristrutturazione, prima di chiedere un preventivo, per controllare un punto segnalato da un condomino o per mostrare a distanza lo stato di una parte dell'edificio. Le immagini possono essere utili a proprietari, amministratori, tecnici, imprese, manutentori, assicurazioni e responsabili di immobili che devono decidere come procedere.
            </p>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ intonaco, rasature, frontalini, sottobalconi, macchie, ferri scoperti, rigonfiamenti e parti deteriorate</li>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di controllo distacchi intonaco, la documentazione visiva può servire in diverse fasi: prima di un sopralluogo, durante una manutenzione, dopo un danno, a fine lavori o nel confronto tra più preventivi. Una serie di immagini ordinate permette di comunicare meglio con chi non era presente sul posto. Un amministratore può mostrare la situazione ai condomini, un proprietario può inviare il materiale a un'impresa, un tecnico può capire quali punti approfondire e un'impresa può preparare domande più precise prima di uscire.
          </p>

          <p className="leading-8 text-gray-300">
            La forza del drone non è solo la ripresa spettacolare, ma la chiarezza. In un lavoro edile serve capire dove si trova il problema, quanto è grande l'area, quali ostacoli ci sono, come si accede e quale parte deve essere controllata. Per questo una pagina dedicata a controllo distacchi intonaco deve spiegare bene cosa può chiedere il cliente e come può presentare la richiesta su DroneGuard.
          </p>
        </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come scrivere una richiesta efficace per controllo distacchi intonaco
          </h2>
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di controllo distacchi intonaco, indica se il punto principale riguarda intonaco, rasature, frontalini, sottobalconi, macchie, ferri scoperti, rigonfiamenti e parti deteriorate. Aggiungi anche se ci sono danni già visibili, infiltrazioni, ristagni, macchie, parti sollevate, materiali caduti, zone irraggiungibili, richieste dell'amministratore o necessità di presentare le immagini a un'impresa. Più la richiesta è precisa, più il pilota potrà rispondere in modo utile.
          </p>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per fotografare possibili distacchi di intonaco su una facciata. Vorrei dettagli dei frontalini, dei sottobalconi e delle parti più alte. Il materiale servirà per parlare con un tecnico, confrontare eventuali preventivi e capire meglio quali parti devono essere controllate prima di organizzare un intervento.”
            </p>
          </div>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="leading-8 text-gray-300">
              Per controllo distacchi intonaco, questo può significare controllare parti sollevate, elementi piegati, zone con ristagni, gronde o pluviali danneggiati, superfici rovinate o punti che richiedono una verifica più approfondita. Le immagini non danno una diagnosi tecnica, ma aiutano a capire dove concentrare l'attenzione.
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per controllo distacchi intonaco?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Se il pilota ti chiede dettagli aggiuntivi, non è un problema: spesso è un segnale positivo. Significa che sta valutando il lavoro con attenzione. Per controllo distacchi intonaco, può essere necessario chiarire altezza, lati da riprendere, presenza di ostacoli, orari migliori, zone accessibili e tipo di immagini desiderate.
          </p>
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per controllo distacchi intonaco?
              </h3>
              <p className="text-gray-300">
                Sì, puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video e documentazione visiva collegata a controllo distacchi intonaco, edilizia, manutenzione, coperture, facciate, condomini e interventi tecnici.
              </p>
            </div>
