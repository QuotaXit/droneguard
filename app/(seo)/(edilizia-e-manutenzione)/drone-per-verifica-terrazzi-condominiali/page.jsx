...
export const metadata = {
  title: "Drone per verifica terrazzi condominiali | DroneGuard",
  description:
    "Drone per verifica terrazzi condominiali: trova piloti drone per foto, video e documentazione visiva di verifica terrazzi condominiali, edilizia, manutenzione, coperture, facciate, condomini e interventi tecnici."
}
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-14 max-w-4xl">
          ...
          <h1 className="mb-6 text-4xl font-bold md:text-5xl">
            Drone per verifica terrazzi condominiali: foto di lastrici, scarichi e pavimentazioni
          </h1>

          <p className="text-lg leading-8 text-gray-300">
            Devi osservare terrazzi condominiali, lastrici solari, pavimentazioni, scarichi, bocchettoni e zone con ristagni o possibili infiltrazioni? Con DroneGuard puoi pubblicare una richiesta e trovare piloti drone disponibili per realizzare foto, video e documentazione visiva dall'alto. Una ripresa aerea può essere molto utile quando il punto da osservare è in quota, quando il cliente non riesce a spiegare bene il problema con semplici foto da terra o quando un tecnico ha bisogno di una prima panoramica prima di organizzare un sopralluogo più preciso. La piattaforma aiuta amministratori, proprietari, tecnici, imprese di impermeabilizzazione e manutentori a trasformare una necessità generica in una richiesta chiara, con informazioni utili su luogo, obiettivo, materiale richiesto, urgenza e condizioni operative.
          </p>
        ...
        <div className="mb-14 grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="leading-7 text-gray-300">
              Richiedi immagini di lastrici, terrazzi, pavimentazioni, guaine, bocchettoni, scarichi, parapetti, ristagni e risvolti. Il drone permette di vedere la scena da una prospettiva più ampia e di raccogliere materiale utile per capire quali punti meritano maggiore attenzione.
            </p>
          </div>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">
              Quando richiedere verifica terrazzi condominiali con drone
            </h2>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <ul className="space-y-4 text-gray-300">
              <li>✅ lastrici, terrazzi, pavimentazioni, guaine, bocchettoni, scarichi, parapetti, ristagni e risvolti</li>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Come scrivere una richiesta efficace per verifica terrazzi condominiali
          </h2>
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">
            Esempio di richiesta per verifica terrazzi condominiali
          </h2>

          <div className="rounded-2xl border border-white/10 bg-[#0B0F2A] p-6">
            <p className="leading-8 text-gray-300">
              “Cerco un pilota drone per fotografare un terrazzo condominiale. Mi servono immagini della pavimentazione, degli scarichi, dei parapetti e dei punti dove ristagna l’acqua. Il materiale servirà per parlare con un tecnico, confrontare eventuali preventivi e capire meglio quali parti devono essere controllate prima di organizzare un intervento.”
            </p>
          </div>
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">
            Quanto costa un servizio drone per verifica terrazzi condominiali?
          </h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Se il pilota ti chiede dettagli aggiuntivi, non è un problema: spesso è un segnale positivo. Significa che sta valutando il lavoro con attenzione. Per verifica terrazzi condominiali, può essere necessario chiarire altezza, lati da riprendere, presenza di ostacoli, orari migliori, zone accessibili e tipo di immagini desiderate.
          </p>
          ...
          <div className="space-y-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <h3 className="mb-2 text-xl font-semibold">
                Posso usare DroneGuard per verifica terrazzi condominiali?
              </h3>
              <p className="text-gray-300">
                Sì, puoi pubblicare una richiesta e cercare piloti drone disponibili per foto, video e documentazione visiva collegata a verifica terrazzi condominiali, edilizia, manutenzione, coperture, facciate, condomini e interventi tecnici.
              </p>
            </div>
