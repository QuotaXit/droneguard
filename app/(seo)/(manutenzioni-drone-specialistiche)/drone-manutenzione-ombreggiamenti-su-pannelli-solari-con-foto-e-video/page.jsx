...
export const metadata = {
  title: "Ombreggiamenti su pannelli solari con foto e video | DroneGuard",
  description:
    "Ombreggiamenti su pannelli solari con foto e video: trova piloti drone per foto, video e documentazione visiva di ombreggiamenti su pannelli solari. Pubblica una richiesta su DroneGuard e ricevi candidature da operatori interessati."
}
    ...
    <main className="min-h-screen bg-[#0B0F2A] text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold">Quando richiedere ombreggiamenti su pannelli solari con foto e video con drone</h2>
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Per ombreggiamenti su pannelli solari con foto e video, questa chiarezza può fare la differenza. Un amministratore può spiegare meglio una situazione ai condomini, un tecnico può preparare domande più precise, un impresa può capire se il lavoro merita un sopralluogo, un azienda può archiviare lo stato di un area e un proprietario può mostrare il problema a distanza senza affidarsi solo a descrizioni verbali.
          </p>
          <p className="leading-8 text-gray-300">
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="leading-8 text-gray-300">
              Per ombreggiamenti su pannelli solari con foto e video, specifica se vuoi una panoramica generale, dettagli ravvicinati, video dall alto o una raccolta ordinata per lato, zona o punto critico. Questo aiuta il pilota a capire quanto deve essere precisa la documentazione e quali parti non devono mancare.
            </p>
          </div>
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
        ...
        <div className="mb-14">
          ...
          <p className="mb-5 leading-8 text-gray-300">
            Nel caso di ombreggiamenti su pannelli solari con foto e video, indica se il punto principale riguarda alberi, camini, parapetti, edifici vicini, antenne, colmi, zone d ombra e orientamento. Aggiungi anche se ci sono danni già visibili, urgenze, accessi difficili, zone da evitare, necessità di presentare il materiale a un tecnico o bisogno di foto da usare per un preventivo.
          </p>
          <p className="leading-8 text-gray-300">
        ...
        <div className="mb-14 rounded-3xl border border-white/10 bg-white/5 p-8">
          <h2 className="mb-6 text-3xl font-bold">Esempio di richiesta per ombreggiamenti su pannelli solari con foto e video</h2>
        ...
        <div className="mb-14 grid gap-10 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="leading-8 text-gray-300">
              Per ombreggiamenti su pannelli solari con foto e video, una documentazione ordinata può anche aiutare a confrontare più preventivi. Quando tutti vedono gli stessi punti, la conversazione diventa più concreta e si riducono fraintendimenti su posizione, dimensione e urgenza.
            </p>
          </div>
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
        ...
        <div className="mb-14">
          <h2 className="mb-4 text-3xl font-bold">Quanto costa un servizio drone per ombreggiamenti su pannelli solari con foto e video?</h2>
          <p className="mb-5 leading-8 text-gray-300">
        ...
        <div className="mb-14">
          ...
          <div className="space-y-5">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <p className="text-gray-300">Sì. Puoi usare DroneGuard per pubblicare una richiesta collegata a ombreggiamenti su pannelli solari con foto e video e ricevere candidature da piloti drone interessati.</p>
            </div>
        ...
        <div className="rounded-3xl bg-white p-8 text-[#0B0F2A] md:p-10">
          <h2 className="mb-4 text-3xl font-bold">Trova un pilota drone per ombreggiamenti su pannelli solari con foto e video</h2>
          <p className="mb-6 max-w-3xl leading-8 text-gray-700">
            Registrati su DroneGuard, pubblica una richiesta e trova piloti drone disponibili per ombreggiamenti su pannelli solari con foto e video, foto dall alto, video, controlli visivi e documentazione utile. La piattaforma ti aiuta a trasformare un esigenza generica in una richiesta chiara e più facile da valutare.
          </p>
          <Link href="/register">
            <button className="rounded-xl bg-green-500 px-6 py-3 font-semibold text-black transition hover:bg-green-400">
              Registrati gratis
